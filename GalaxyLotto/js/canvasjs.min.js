...
(function () {
    ...
    function Ra(a) {
        function d() { } d.prototype = a;
        return new d
    }
    function Ia(a, d, b) {
        "millisecond" === b ? a.setMilliseconds(a.getMilliseconds() + 1 * d) :
        "second" === b ? a.setSeconds(a.getSeconds() + 1 * d) :
        "minute" === b ? a.setMinutes(a.getMinutes() + 1 * d) :
        "hour" === b ? a.setHours(a.getHours() + 1 * d) :
        "day" === b ? a.setDate(a.getDate() + 1 * d) :
        "week" === b ? a.setDate(a.getDate() + 7 * d) :
        "month" === b ? a.setMonth(a.getMonth() + 1 * d) :
        "year" === b && a.setFullYear(a.getFullYear() + 1 * d);
        return a
    }
    function N(a, d) {
        var b = !1;
    ...
    function Sa(a) {
        a.roundRect = function (a, b, c, f, g, h, l, k) {
            ...
            this.lineWidth = h; this.beginPath();
            this.moveTo(a + g, b); this.lineTo(a + c - g, b);
    ...
    function L(a, d, b, c) {
        ...
        else if (a.attachEvent) a.attachEvent("on" + d, function (c) { c = c || window.event; c.preventDefault = c.preventDefault || function () { c.returnValue = !1 }; c.stopPropagation = c.stopPropagation || function () { c.cancelBubble = !0 }; b.call(a, c) }); else return !1
    }
    function Ma(a, d, b) {
        a *= P; d *= P;
        ...
        d = !0;
        for (b = 0; 4 > b; b++)
            if (a[b] !== a[b + 4] | a[b] !== a[b + 8] | a[b] !== a[b + 12]) { d = !1; break }
    ...
    function Ua(a) {
        if (!Oa) {
            ...
            if (a.creditHref && a.creditText) {
                ...
                if (0 === a.renderCount || d || b) a._creditLink.setAttribute("href", a.creditHref), a._creditLink.innerHTML = a.creditText; a._creditLink && a.creditHref && a.creditText ? (a._creditLink.parentElement || a._canvasJSContainer.appendChild(a._creditLink), a._creditLink.style.top = a.height - 14 + "px") : a._creditLink.parentElement && a._canvasJSContainer.removeChild(a._creditLink)
            }
        }
    } function ia(a, d) {
        var b = document.createElement("canvas"); b.setAttribute("class", "canvasjs-chart-canvas");
        ta(b, a, d); v || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(b); return b
    } function Ca(a, d, b) {
        if (a && d && b) {
            b = b + "." + d;
            var c = "image/" + d;
    ...
    function $() {
        for (var a = null, d = 0; d < arguments.length; d++) (a = arguments[d]) && a.style && (a.style.display = "none")
    }
    function M(a, d, b, c) {
        this._defaultsKey = a;
        this.parent = c;
    ...
    function z(a, d) {
        d = d || {}; z.base.constructor.call(this, "Chart", d, d.theme ? d.theme : "theme1"); var b = this; this._containerId = a; this._objectsInitialized = !1; this.overlaidCanvasCtx = this.ctx = null; this._indexLabels = []; this._panTimerId = 0; this._lastTouchEventType = ""; this._lastTouchData = null; this.isAnimating =
        !1; this.renderCount = 0; this.panEnabled = this.disableToolTip = this.animatedRender = !1; this._defaultCursor = "default"; this.plotArea = { canvas: null, ctx: null, x1: 0, y1: 0, x2: 0, y2: 0, width: 0, height: 0 }; this._dataInRenderedOrder = []; if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            new V(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = { axisX: [], axisX2: [], axisY: [], axisY2: [] })
    ...
    } function la(a, d, b, c, f) { "undefined" === typeof f && (f = 0); this._padding = f; this._x1 = a; this._y1 = d; this._x2 = b; this._y2 = c; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding } function X(a, d) { X.base.constructor.call(this, "TextBlock", d); this.ctx = a; this._isDirty = !0; this._wrappedText = null } function oa(a, d) {
        oa.base.constructor.call(this, "Title", d, a.theme, a); this.chart = a; this.canvas = a.canvas; this.ctx = this.chart.ctx;
    ...
    } function xa(a, d) { xa.base.constructor.call(this, "Subtitle", d, a.theme, a); this.chart = a; this.canvas = a.canvas; this.ctx = this.chart.ctx; this.optionsName = "subtitles"; this.isOptionsInArray = !0; "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.height = this.width = null; this.bounds = { x1: null, y1: null, x2: null, y2: null } } function ya(a, d) {
        ya.base.constructor.call(this, "Legend", d, a.theme, a); this.chart =
        ...
        A.base.constructor.call(this, "Axis", d, a.theme, a); this.chart = a; this.canvas = a.canvas; this.ctx = a.ctx; this.intervalStartPosition = this.maxHeight = this.maxWidth = 0; this.labels = []; this.dataSeries = []; this._stripLineLabels = this._ticks = this._labels = null; this.dataInfo = {
        ...
        pa.base.constructor.call(this, "StripLine", d, b, f); this.id = c; this.chart = a; this.ctx = this.chart.ctx; this.label = this.label; this.axis = f;
    ...
    } function V(a, d) { V.base.constructor.call(this, "ToolTip", d, a.theme, a); this.chart = a; this.canvas = a.canvas; this.ctx = this.chart.ctx; this.currentDataPointIndex = this.currentSeriesIndex = -1; this._timerId = 0; this._prevY = this._prevX = NaN; this.optionsName = "toolTip"; this._initialize() } function na(a) {
    ...
    } function qa(a) { var d; a && ra[a] && (d = ra[a]); qa.base.constructor.call(this, "CultureInfo", d) } function Ea(a) { this.chart = a; this.ctx = this.chart.plotArea.ctx; this.animations = []; this.animationRequestId = null } var J = {}, v = !!document.createElement("canvas").getContext, ea = {
        Chart: {
            ...
            padding: 0, text: null, verticalAlign: "top", horizontalAlign: "center",
            fontSize: 20, fontFamily: "Calibri", fontWeight: "normal", fontColor: "black", fontStyle: "normal", borderThickness: 0, borderColor: "black", cornerRadius: 0, backgroundColor: v ? "transparent" : null, margin: 5, wrap: !0, maxWidth: null, dockInsidePlotArea: !1, publicProperties: { options: "readWrite", bounds: "readOnly", chart: "readOnly" }
        }, Subtitle: {
            padding: 0, text: null, verticalAlign: "top", horizontalAlign: "center", fontSize: 14, fontFamily: "Calibri", fontWeight: "normal", fontColor: "black", fontStyle: "normal", borderThickness: 0, borderColor: "black",
        ...
        Axis: {
            ...
            value: null, startValue: null, endValue: null, color: "orange", opacity: null, thickness: 2, lineDashType: "solid",
            ...
            name: null, dataPoints: null, label: "", bevelEnabled: !1, highlightEnabled: !0, cursor: "default", indexLabel: "", indexLabelPlacement: "auto",
            ...
            mouseover: null, mouseout: null, mousemove: null, click: null, toolTipContent: null, visible: !0, publicProperties: { options: "readWrite", axisX: "readWrite", axisY: "readWrite", chart: "readOnly" }
        ...
        theme1: {
            Chart: { colorSet: "colorSet1" }, Title: { fontFamily: v ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, Subtitle: {
            ...
            Chart: { colorSet: "colorSet2" }, Title: { fontFamily: "impact, charcoal, arial black, sans-serif", fontSize: 32, fontColor: "#333333", verticalAlign: "top", margin: 5 }, Subtitle: {
                ...
                margin: 5
            }, Axis: { titleFontSize: 22, titleFontColor: "rgb(98,98,98)", titleFontFamily: v ? "monospace, sans-serif,arial black" : "arial", titleFontWeight: "bold", labelFontFamily: v ? "monospace, Courier New, Courier" : "arial", labelFontSize: 16, labelFontColor: "grey", labelFontWeight: "bold", tickColor: "grey", tickThickness: 2, gridThickness: 2, gridColor: "grey", lineColor: "grey", lineThickness: 0 }, Legend: { verticalAlign: "bottom", horizontalAlign: "center", fontFamily: v ? "monospace, sans-serif,arial black" : "arial" }, DataSeries: {
                indexLabelFontColor: "grey",
                indexLabelFontFamily: v ? "Courier New, Courier, monospace" : "arial", indexLabelFontWeight: "bold", indexLabelFontSize: 18, indexLabelLineThickness: 1
            }
        }, theme3: {
            Chart: { colorSet: "colorSet1" }, Title: { fontFamily: v ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri", fontSize: 32, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, Subtitle: {
                fontFamily: v ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri", fontSize: 16, fontColor: "#3A3A3A",
    ...
    }, H = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") }, La = {}, da =
    null, Fa = function () {
        ...
        h = /[^-+\dA-Z]/g; return function (l, k, n) {
            var m = n ? n.days : d, p = n ? n.months : c, e = n ? n.shortDays : b, r = n ? n.shortMonths : f; n = ""; var q = !1; l = l && l.getTime ? l : l ? new Date(l) : new Date; if (isNaN(l)) throw SyntaxError("invalid date"); "UTC:" === k.slice(0, 4) && (k = k.slice(4), q = !0); n = q ? "getUTC" : "get"; var s = l[n + "Date"](), u = l[n + "Day"](), w = l[n + "Month"](), y = l[n + "FullYear"](), t = l[n + "Hours"](), v = l[n + "Minutes"](), aa = l[n + "Seconds"](), ca = l[n + "Milliseconds"](), x = q ? 0 : l.getTimezoneOffset(); return n = k.replace(a, function (a) {
                switch (a) {
                    ...
                    2) + N(Math.abs(x) % 60, 2); default: return a.slice(1, a.length - 1)
                }
            })
        }
    }(), fa = function (a, d, b) {
        if (null === a) return ""; a = Number(a); var c = 0 > a ? !0 : !1; c && (a *= -1); var f = b ? b.decimalSeparator : ".", g = b ? b.digitGroupSeparator : ",", h = ""; d = String(d); var h = 1, l = b = "", k = -1, n = [], m = [], p = 0, e = 0, r = 0, q = !1, s = 0, l = d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); d = null; for (var u = 0; l && u < l.length; u++) if (d = l[u], "." === d && 0 > k) k = u; else {
            if ("%" === d) h *= 100; else if ("\u2030" === d) { h *= 1E3; continue } else if ("," === d[0] && "." === d[d.length - 1]) {
                h /=
                Math.pow(1E3, d.length - 1); k = u + d.length - 1; continue
            } else "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || (q = !0); 0 > k ? (n.push(d), "#" === d || "0" === d ? p++ : "," === d && r++) : (m.push(d), "#" !== d && "0" !== d || e++)
        } q && (d = Math.floor(a), s = (0 === d ? "" : String(d)).length - p, h /= Math.pow(10, s)); 0 > k && (k = u); h = (a * h).toFixed(e); d = h.split("."); h = (d[0] + "").split(""); a = (d[1] + "").split(""); h && "0" === h[0] && h.shift(); for (u = q = l = e = k = 0; 0 < n.length;) if (d = n.pop(), "#" === d || "0" === d) if (k++, k === p) {
            var w = h, h = []; if ("0" === d) for (d = p - e - (w ? w.length : 0) ; 0 < d;) w.unshift("0"),
            d--; for (; 0 < w.length;) b = w.pop() + b, u++, 0 === u % q && (l === r && 0 < w.length) && (b = g + b); c && (b = "-" + b)
            ...
            return N(s,
            a.length)
        })); c = ""; for (g = !1; 0 < m.length;) d = m.shift(), "#" === d || "0" === d ? 0 < a.length && 0 !== Number(a.join("")) ? (c += a.shift(), g = !0) : "0" === d && (c += "0", g = !0) : 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? c += d.slice(1, d.length - 1) : "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? c += d : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), c += d.replace(/[0]+/, function (a) { return N(s, a.length) })); return b + ((g ? f : "") + c)
    }, za = function (a) {
        var d = 0, b = 0; a = a || window.event;
        a.offsetX || 0 === a.offsetX ? (d = a.offsetX, b = a.offsetY) : a.layerX || 0 == a.layerX ? (d = a.layerX, b = a.layerY) : (d = a.pageX - a.target.offsetLeft, b = a.pageY - a.target.offsetTop); return { x: d, y: b }
    ...
    }; M.prototype.get = function (a) { var d = ea[this._defaultsKey]; if ("options" === a) return this.options && this.options._isPlaceholder ? null : this.options; if (d.hasOwnProperty(a) || d.publicProperties && d.publicProperties.hasOwnProperty(a)) return this[a]; window.console && window.console.log('Property "' + a + "\" doesn't exist. Please check for typo.") }; M.prototype.set = function (a, d, b) {
        b = "undefined" === typeof b ? !0 : b; var c =
        ea[this._defaultsKey]; if ("options" === a) this.createUserOptions(d); else if (c.hasOwnProperty(a) || c.publicProperties && c.publicProperties.hasOwnProperty(a) && "readWrite" === c.publicProperties[a]) this.options._isPlaceholder && this.createUserOptions(), this.options[a] = d; else {
        ...
        if ("undefined" !== typeof a || this.options._isPlaceholder) if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
            ...
            this.parent.options[this.optionsName], b = d.length; this.options._isPlaceholder || (sa(d), b = d.indexOf(this.options)); this.options = "undefined" === typeof a ? {} : a; d[b] = this.options
        ...
        a = "undefined" === typeof a ? !0 : a; if (this.isOptionsInArray) {
            var d =
            this.parent.options[this.optionsName]; sa(d); var b = d.indexOf(this.options); 0 <= b && d.splice(b, 1)
        } else delete this.parent.options[this.optionsName]; a && (chart = this.chart || this, chart.render())
    }; M.prototype.updateOption = function (a) {
        var d = ea[this._defaultsKey], b = this.options.theme ? this.options.theme : this.chart && this.chart.options.theme ? this.chart.options.theme : "theme1", c = {}, f = this[a]; b && (ka[b] && ka[b][this._defaultsKey]) && (c = ka[b][this._defaultsKey]); a in d && (f = a in this.options ? this.options[a] : c && a in c ?
    ...
    function (a, d, b) { a && d && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({ context: b || this, eventHandler: d })) }; M.prototype.removeEventListener = function (a, d) { if (a && d && this._eventListeners[a]) for (var b = this._eventListeners[a], c = 0; c < b.length; c++) if (b[c].eventHandler === d) { b[c].splice(c, 1); break } }; M.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; M.prototype.dispatchEvent = function (a, d, b) {
    ...
    }; U(z, M); z.prototype._updateOptions = function () {
        ...
        "click", function () {
            a.toolTip.hide(); a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, Z(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1); if (a.sessionVariables.axisX) for (var b = 0; b < a.sessionVariables.axisX.length; b++) a.sessionVariables.axisX[b].newViewportMinimum = null, a.sessionVariables.axisX[b].newViewportMaximum = null; if (a.sessionVariables.axisX2) for (b = 0; b < a.sessionVariables.axisX2.length; b++) a.sessionVariables.axisX2[b].newViewportMinimum =
        ...
        this.exportEnabled && v && (this._menuButton = document.createElement("button"), Z(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), L(this._menuButton, "click", function () { "none" !== a._dropdownMenu.style.display || a._dropDownCloseTime && 500 >= (new Date).getTime() - a._dropDownCloseTime.getTime() || (a._dropdownMenu.style.display = "block", a._menuButton.blur(), a._dropdownMenu.focus()) }, !0)); if (!this._dropdownMenu && this.exportEnabled && v) {
            ...
            d.innerHTML = this._cultureInfo.saveJPGText; this._dropdownMenu.appendChild(d); L(d, "mouseover", function () { this.style.backgroundColor = "#EEEEEE" }, !0); L(d, "mouseout", function () { this.style.backgroundColor = "transparent" }, !0); L(d, "click", function () { Ca(a.canvas, "jpeg", a.exportFileName); $(a._dropdownMenu) }, !0); d = document.createElement("div"); d.style.cssText = "padding: 2px 15px 2px 10px"; d.innerHTML = this._cultureInfo.savePNGText; this._dropdownMenu.appendChild(d); L(d, "mouseover", function () {
                this.style.backgroundColor =
                "#EEEEEE"
            }, !0); L(d, "mouseout", function () { this.style.backgroundColor = "transparent" }, !0); L(d, "click", function () { Ca(a.canvas, "png", a.exportFileName); $(a._dropdownMenu) }, !0)
        } "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? Z(a, a._zoomButton, "zoom") : Z(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && Z(a, a._resetButton, "reset")); this.options.toolTip && this.toolTip.options !== this.options.toolTip && (this.toolTip.options = this.options.toolTip); for (var b in this.toolTip.options) this.toolTip.options.hasOwnProperty(b) &&
        this.toolTip.updateOption(b)
    }; z.prototype._updateSize = function () { var a = 0, d = 0; this.options.width ? a = this.width : this.width = a = 0 < this.container.clientWidth ? this.container.clientWidth : this.width; this.options.height ? d = this.height : this.height = d = 0 < this.container.clientHeight ? this.container.clientHeight : this.height; return this.canvas.width !== a * P || this.canvas.height !== d * P ? (ta(this.canvas, a, d), ta(this.overlaidCanvas, a, d), ta(this._eventManager.ghostCanvas, a, d), !0) : !1 }; z.prototype._initialize = function () {
        this._animator ?
        ...
        []; this._events = []; this._eventManager && this._eventManager.reset(); this.plotInfo = { axisPlacement: null, axisXValueType: null, plotTypes: [] }; this.layoutManager = new la(0, 0, this.width, this.height, 2); this.plotArea.layoutManager && this.plotArea.layoutManager.reset(); this.data = []; var a = 0; if (this.options.data) for (var d = 0; d < this.options.data.length; d++) if (a++, !this.options.data[d].type || 0 <= z._supportedChartTypes.indexOf(this.options.data[d].type)) {
        ...
        } J.fAWm && J.fAWm(this); Ua(this); this._objectsInitialized = !0
    ...
    z.prototype.render = function (a) {
        a && (this.options = a); this._initialize(); var d = []; for (a = 0; a < this.data.length; a++) if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
            ...
            "axisY", "left", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new A(this, this.options.axisY, "axisY", "bottom", 0))), this.data[a].axisY = this.axisY[0], this.axisY[0].dataSeries.push(this.data[a]); if ("secondary" === this.data[a].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                ...
                "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new A(this, this.options.axisY2[b], "axisY", "top", b)); this.data[a].axisY = this.axisY2[0 <= this.data[a].axisYIndex && this.data[a].axisYIndex < this.axisY2.length ? this.data[a].axisYIndex : 0]; this.axisY2[0 <= this.data[a].axisYIndex && this.data[a].axisYIndex < this.axisY2.length ? this.data[a].axisYIndex : 0].dataSeries.push(this.data[a])
            } else this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new A(this,
            this.options.axisY2, "axisY", "right", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new A(this, this.options.axisY2, "axisY", "top", 0))), this.data[a].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[a]); if (!this.data[a].axisXType || "primary" === this.data[a].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
            ...
            new A(this, this.options.axisX, "axisX", "bottom", 0)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new A(this, this.options.axisX, "axisX", "left", 0))), this.data[a].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[a]); if ("secondary" === this.data[a].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
        ...
        } this.animatedRender && 0 < this._indexLabels.length && (a = ia(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(a))); var k = this; 0 < c.length ? (k.disableToolTip = !0, k._animator.animate(200, k.animationDuration, function (a) {
            k.ctx.clearRect(0, 0, k.width, k.height); k.ctx.drawImage(f, 0, 0, Math.floor(k.width * P), Math.floor(k.height * P), 0, 0, k.width, k.height); for (var b = 0; b < c.length; b++) l = c[b], 1 > a && "undefined" !== typeof l.startTimePercent ? a >= l.startTimePercent && l.animationCallback(l.easingFunction(a -
            l.startTimePercent, 0, 1, 1 - l.startTimePercent), l) : l.animationCallback(l.easingFunction(a, 0, 1, 1), l); k.dispatchEvent("dataAnimationIterationEnd", { chart: k })
        }, function () { c = []; for (var a = 0; a < k.plotInfo.plotTypes.length; a++) for (var b = k.plotInfo.plotTypes[a], d = 0; d < b.plotUnits.length; d++) b.plotUnits[d].targetCanvas = null; f = null; k.disableToolTip = !1 })) : (0 < k._indexLabels.length && k.renderIndexLabels(), k.dispatchEvent("dataAnimationIterationEnd", { chart: k })); this.attachPlotAreaEventHandlers(); this.zoomEnabled || (this.panEnabled ||
        !this._zoomButton || "none" === this._zoomButton.style.display) || $(this._zoomButton, this._resetButton); this.toolTip._updateToolTip(); this.renderCount++
    }; z.prototype.attachPlotAreaEventHandlers = function () { this.attachEvent({ context: this, chart: this, mousedown: this._plotAreaMouseDown, mouseup: this._plotAreaMouseUp, mousemove: this._plotAreaMouseMove, cursor: this.zoomEnabled ? "col-resize" : "move", cursor: this.panEnabled ? "move" : "default", capture: !0, bounds: this.plotArea }) }; z.prototype.categoriseDataSeries = function () {
        for (var a =
        "", d = 0; d < this.data.length; d++) if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= z._supportedChartTypes.indexOf(a.type)) {
            ...
            b.plotUnits[h].axisYIndex === a.axisYIndex && b.plotUnits[h].axisXIndex === a.axisXIndex) { g = !0; f = b.plotUnits[h]; break } g || (f = {
                ...
                a.axisXIndex && a.axisXIndex < this.axisX.length ? a.axisXIndex : 0] : this.axisX2[0 <= a.axisXIndex && a.axisXIndex < this.axisX2.length ? a.axisXIndex : 0], dataSeriesIndexes: [], yTotals: []
        ...
        for (var a =
        0; a < this.data.length; a++) { var d = this.data[a]; if (d.dataPoints) for (var b = d.dataPoints.length, c = 0; c < b; c++) d.dataPointIds[c] = ++this._eventManager.lastObjectId }
        ...
        this.assignIdToDataPoints(); this.categoriseDataSeries(); for (var a = 0; a < this.plotInfo.plotTypes.length; a++) for (var d = this.plotInfo.plotTypes[a], b = 0; b < d.plotUnits.length; b++) {
            var c = d.plotUnits[b]; "line" === c.type || "stepLine" === c.type || "spline" === c.type || "column" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" ===
    ...
    function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
            var l = this.data[a.dataSeriesIndexes[h]], k = 0, n = !1, m = !1, p; if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement) var e = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ?
            this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, r = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (l.dataPoints[k].x && l.dataPoints[k].x.getTime || "dateTime" === l.xValueType) g = !0; for (k = 0; k < l.dataPoints.length; k++) {
                "undefined" === typeof l.dataPoints[k].x && (l.dataPoints[k].x = k + (a.axisX.logarithmic ?
                1 : 0)); l.dataPoints[k].x.getTime ? (g = !0, c = l.dataPoints[k].x.getTime()) : c = l.dataPoints[k].x; f = l.dataPoints[k].y; c < b.min && (b.min = c); c > b.max && (b.max = c); f < d.min && (d.min = f); f > d.max && (d.max = f); if (0 < k) {
                    if (a.axisX.logarithmic) { var q = c / l.dataPoints[k - 1].x; 1 > q && (q = 1 / q); b.minDiff > q && 1 !== q && (b.minDiff = q) } else q = c - l.dataPoints[k - 1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q); null !== f && null !== l.dataPoints[k - 1].y && (a.axisY.logarithmic ? (q = f / l.dataPoints[k - 1].y, 1 > q && (q = 1 / q), d.minDiff > q && 1 !== q && (d.minDiff = q)) : (q =
                    f - l.dataPoints[k - 1].y, 0 > q && (q *= -1), d.minDiff > q && 0 !== q && (d.minDiff = q)))
                } if (c < e && !n) null !== f && (p = c); else { if (!n && (n = !0, 0 < k)) { k -= 2; continue } if (c > r && !m) m = !0; else if (c > r && m) continue; l.dataPoints[k].label && (a.axisX.labels[c] = l.dataPoints[k].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); null === f ? b.viewPortMin === c && p < c && (b.viewPortMin = p) : (f < d.viewPortMin && (d.viewPortMin = f), f > d.viewPortMax && (d.viewPortMax = f)) }
    ...
    z.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], l = [], k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]], p = 0, e = !1, r = !1, q; if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum :
                this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, u = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (m.dataPoints[p].x && m.dataPoints[p].x.getTime || "dateTime" === m.xValueType) g = !0; for (p = 0; p < m.dataPoints.length; p++) {
                    "undefined" === typeof m.dataPoints[p].x &&
                    (m.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); m.dataPoints[p].x.getTime ? (g = !0, c = m.dataPoints[p].x.getTime()) : c = m.dataPoints[p].x; x(m.dataPoints[p].y) ? f = 0 : (f = m.dataPoints[p].y, 0 === n && (k = Math.min(f, k))); c < b.min && (b.min = c); c > b.max && (b.max = c); if (0 < p) {
                        if (a.axisX.logarithmic) { var w = c / m.dataPoints[p - 1].x; 1 > w && (w = 1 / w); b.minDiff > w && 1 !== w && (b.minDiff = w) } else w = c - m.dataPoints[p - 1].x, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w); null !== f && null !== m.dataPoints[p - 1].y && (a.axisY.logarithmic ? 0 < f && (w = f / m.dataPoints[p -
                        ...
                        if (!e && (e = !0, 0 < p)) { p -= 2; continue } if (c > u && !r) r = !0; else if (c > u && r) continue; m.dataPoints[p].label && (a.axisX.labels[c] = m.dataPoints[p].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); null === m.dataPoints[p].y ? b.viewPortMin === c && q < c && (b.viewPortMin = q) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f),
                        0 <= f ? h[c] = h[c] ? h[c] + f : f : l[c] = l[c] ? l[c] + f : f)
                    }
                } this.plotInfo.axisXValueType = m.xValueType = g ? "dateTime" : "number"
            } for (p in h) h.hasOwnProperty(p) && !isNaN(p) && (a = h[p], a < d.min && (d.min = Math.min(a, k)), a > d.max && (d.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, k)), a > d.viewPortMax && (d.viewPortMax = a))); for (p in l) l.hasOwnProperty(p) && !isNaN(p) && (a = l[p], a < d.min && (d.min = Math.min(a, k)), a > d.max && (d.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a,
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = !1, l = !1, k = [], n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]], p = 0, e = !1, r = !1, q; if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
                this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, u = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (m.dataPoints[p].x && m.dataPoints[p].x.getTime || "dateTime" === m.xValueType) g = !0; for (p = 0; p < m.dataPoints.length; p++) {
                    "undefined" ===
                    typeof m.dataPoints[p].x && (m.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); m.dataPoints[p].x.getTime ? (g = !0, c = m.dataPoints[p].x.getTime()) : c = m.dataPoints[p].x; f = x(m.dataPoints[p].y) ? null : m.dataPoints[p].y; c < b.min && (b.min = c); c > b.max && (b.max = c); if (0 < p) {
                        if (a.axisX.logarithmic) { var w = c / m.dataPoints[p - 1].x; 1 > w && (w = 1 / w); b.minDiff > w && 1 !== w && (b.minDiff = w) } else w = c - m.dataPoints[p - 1].x, 0 > w && (w *= -1), b.minDiff > w && 0 !== w && (b.minDiff = w); x(f) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < f && (w = f / m.dataPoints[p -
                        1].y, 1 > w && (w = 1 / w), d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = f - m.dataPoints[p - 1].y, 0 > w && (w *= -1), d.minDiff > w && 0 !== w && (d.minDiff = w)))
                    } if (c < s && !e) null !== f && (q = c); else {
                        if (!e && (e = !0, 0 < p)) { p -= 2; continue } if (c > u && !r) r = !0; else if (c > u && r) continue; m.dataPoints[p].label && (a.axisX.labels[c] = m.dataPoints[p].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); null === f ? b.viewPortMin === c && q < c && (b.viewPortMin = q) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f), 0 <= f ? h = !0 : 0 > f && (l = !0), k[c] =
            ...
            -99)) : !h && l && (d.max = x(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = x(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)); d.viewPortMin = d.min; d.viewPortMax = d.max; a.dataPointYSums = k
        }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g, h, l = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
            var n = this.data[a.dataSeriesIndexes[k]], m = 0, p = !1, e = !1, r, q, s; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var u =
            ...
            this.options.axisX.maximum : Infinity; if (n.dataPoints[m].x && n.dataPoints[m].x.getTime || "dateTime" === n.xValueType) l = !0; for (m = 0; m < n.dataPoints.length; m++) {
                ...
                (b.max = c); g < d.min && (d.min = g); h > d.max && (d.max = h); 0 < m && (a.axisX.logarithmic ? (q = c / n.dataPoints[m - 1].x, 1 > q && (q = 1 / q), b.minDiff > q && 1 !== q && (b.minDiff = q)) : (q = c - n.dataPoints[m - 1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q)), f && (null !== f[0] && n.dataPoints[m - 1].y && null !== n.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (q = f[0] / n.dataPoints[m - 1].y[0], 1 > q && (q = 1 / q), d.minDiff > q && 1 !== q && (d.minDiff = q)) : (q = f[0] - n.dataPoints[m - 1].y[0], 0 > q && (q *= -1), d.minDiff > q && 0 !== q && (d.minDiff = q)))); if (!(c < u) || p) {
                    if (!p && (p = !0, 0 < m)) {
                        m -=
                        2; r = s; continue
                    } if (c > w && !e) e = !0; else if (c > w && e) continue; n.dataPoints[m].label && (a.axisX.labels[c] = n.dataPoints[m].label); c < b.viewPortMin && (b.viewPortMin = c); c > b.viewPortMax && (b.viewPortMax = c); if (b.viewPortMin === c && f) for (y = 0; y < f.length; y++) if (null === f[y] && r < c) { b.viewPortMin = r; break } null === f ? b.viewPortMin === c && r < c && (b.viewPortMin = r) : (g < d.viewPortMin && (d.viewPortMin = g), h > d.viewPortMax && (d.viewPortMax = h))
                }
            } this.plotInfo.axisXValueType = n.xValueType = l ? "dateTime" : "number"
        }
    }; z.prototype.getDataPointAtXY = function (a,
    d, b) {
        b = b || !1; for (var c = [], f = this._dataInRenderedOrder.length - 1; 0 <= f; f--) { var g = null; (g = this._dataInRenderedOrder[f].getDataPointAtXY(a, d, b)) && c.push(g) } a = null; d = !1; for (b = 0; b < c.length; b++) if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type) if (f = S("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= f / 2) { d = !0; break } for (b = 0; b < c.length; b++) d && "line" !== c[b].dataSeries.type && "stepLine" !== c[b].dataSeries.type && "area" !==
        c[b].dataSeries.type && "stepArea" !== c[b].dataSeries.type || (a ? c[b].distance <= a.distance && (a = c[b]) : a = c[b]); return a
    }; z.prototype.getObjectAtXY = function (a, d, b) { var c = null; if (b = this.getDataPointAtXY(a, d, b || !1)) c = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (v) c = Ma(a, d, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) { var f = this.legend.items[b]; a >= f.x1 && (a <= f.x2 && d >= f.y1 && d <= f.y2) && (c = f.id) } return c }; z.prototype.getAutoFontSize = function (a, d, b) {
        a /= 400; return Math.max(10, Math.round(Math.min(this.width,
        this.height) * a))
    }; z.prototype.resetOverlayedCanvas = function () { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) }; z.prototype.clearCanvas = function () { this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) }; z.prototype.attachEvent = function (a) { this._events.push(a) }; z.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            a, f = null; switch (a.type) { case "touchstart": case "MSPointerDown": d = ["mousemove", "mousedown"]; this._lastTouchData = za(c); this._lastTouchData.time = new Date; break; case "touchmove": case "MSPointerMove": d = ["mousemove"]; break; case "touchend": case "MSPointerUp": d = "touchstart" === this._lastTouchEventType || "MSPointerDown" === this._lastTouchEventType ? ["mouseup", "click"] : ["mouseup"]; break; default: return } if (!(b && 1 < b.length)) {
                f = za(c); f.time = new Date; try {
                    var g = f.y - this._lastTouchData.y, h = f.time - this._lastTouchData.time;
                    if (15 < Math.abs(g) && (this._lastTouchData.scroll || 200 > h)) { this._lastTouchData.scroll = !0; var l = window.parent || window; l && l.scrollBy && l.scrollBy(0, -g) }
                } catch (k) { } this._lastTouchEventType = a.type; if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < d.length; b++) f = d[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(f, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1, !1, !1, !1, 0, null), c.target.dispatchEvent(g), a.preventManipulation &&
        ...
        0; g < this.axisX2.length; g++) b[c[f]].push({ viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum }); this.dispatchEvent(a, b, this)
    }; z.prototype._mouseEventHandler = function (a) {
        "undefined" === typeof a.target && a.srcElement && (a.target = a.srcElement); var d = za(a), b = a.type, c, f; a.which ? f = 3 == a.which : a.button && (f = 2 == a.button); z.capturedEventParam && (c = z.capturedEventParam, "mouseup" === b && (z.capturedEventParam = null, c.chart.overlaidCanvas.releaseCapture ?
    ...
    }; z.prototype._plotAreaMouseDown = function (a, d) { this.isDrag = !0; this.dragStartPoint = { x: a, y: d } }; z.prototype._plotAreaMouseUp = function (a, d) {
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0, c = 0, f = b = null, f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), h = this; "xySwapped" === this.plotInfo.axisPlacement && (b = g, g = f, f = b); b = this.dragStartPoint.x - a; c = this.dragStartPoint.y - d; 2 < Math.abs(b) &&
            8 > Math.abs(b) && (this.panEnabled || this.zoomEnabled) ? this.toolTip.hide() : this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, d); if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) f = { x1: f ? this.plotArea.x1 + b : this.plotArea.x1, y1: g ? this.plotArea.y1 + c : this.plotArea.y1, x2: f ? this.plotArea.x2 + b : this.plotArea.x2, y2: g ? this.plotArea.y2 + c : this.plotArea.y2 }, clearTimeout(h._panTimerId), h._panTimerId = setTimeout(function (b, c, e, f) {
                ...
                this.resetOverlayedCanvas(); b = this.overlaidCanvasCtx.globalAlpha; this.overlaidCanvasCtx.fillStyle = "#A89896"; var c = f ? this.dragStartPoint.x : this.plotArea.x1, l = g ? this.dragStartPoint.y : this.plotArea.y1, k = f ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, n = g ? d - this.dragStartPoint.y : this.plotArea.y2 -
                this.plotArea.y1; this.validateRegion(c, l, f ? a : this.plotArea.x2 - this.plotArea.x1, g ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5"); this.overlaidCanvasCtx.globalAlpha = 0.7; this.overlaidCanvasCtx.fillRect(c, l, k, n); this.overlaidCanvasCtx.globalAlpha = b
            }
        } else this.toolTip.mouseMoveHandler(a, d)
    }; z.prototype._zoomPanToSelectedRegion = function (a, d, b, c, f) {
        a = this.validateRegion(a, d, b, c, f); d = a.axesWithValidRange; b = a.axesRanges;
        if (a.isValid) for (c = 0; c < d.length; c++) f = b[c], d[c].setViewPortRange(f.val1, f.val2); return a.isValid
        ...
        } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width, a.height = d.height; v || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top =
        ...
        var d = a || this.plotArea.ctx, b = this.plotArea, c = 0, f = 0, g = 0, h = 0, l = c = h = f = g = 0, k = 0; for (a = 0; a < this._indexLabels.length; a++) {
            var n = this._indexLabels[a], m = n.chartType.toLowerCase(), p, e, l = S("indexLabelFontColor", n.dataPoint, n.dataSeries), k = S("indexLabelFontSize", n.dataPoint, n.dataSeries); p = S("indexLabelFontFamily", n.dataPoint, n.dataSeries); e = S("indexLabelFontStyle",
            ...
            n.dataPoint.indexLabelFormatter(y) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ? n.dataSeries.indexLabelFormatter(y) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null; if (null !== t && "" !== t) {
                ...
                } else if (0 <= m.indexOf("column")) { if (n.dataPoint.x < aa.viewportMinimum || n.dataPoint.x > aa.viewportMaximum || n.bounds.y1 > b.y2 || n.bounds.y2 < b.y1) continue } else if (0 <= m.indexOf("bar")) { if (n.dataPoint.x < aa.viewportMinimum || n.dataPoint.x > aa.viewportMaximum || n.bounds.x1 > b.x2 || n.bounds.x2 < b.x1) continue } else if (n.dataPoint.x < aa.viewportMinimum || n.dataPoint.x > aa.viewportMaximum) continue; f = h = 2; "horizontal" === y ? (l = r.width, k = r.height) : (k = r.width,
                l = r.height); if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= m.indexOf("line") || 0 <= m.indexOf("area")) w = "auto", h = 4; else if (0 <= m.indexOf("stacked")) "auto" === w && (w = "inside"); else if ("bubble" === m || "scatter" === m) w = "inside"; p = n.point.x - l / 2; "inside" !== w ? (f = b.y1, g = b.y2, 0 < C ? (e = n.point.y - k - h - c, e < f && (e = "auto" === w ? Math.max(n.point.y, f) + h + c : f + h + c, z = e + k > n.point.y)) : (e = n.point.y + h + c, e > g - k - h - c && (e = "auto" === w ? Math.min(n.point.y, g) - k - h - c : g - k - h - c, z = e < n.point.y))) : (f = Math.max(n.bounds.y1, b.y1), g = Math.min(n.bounds.y2,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = this._eventManager.ghostCtx; d.save(); var c = this.plotArea; d.beginPath(); d.rect(c.x1, c.y1, c.width, c.height); d.clip(); for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                var h = a.dataSeriesIndexes[g], l = this.data[h]; d.lineWidth = l.lineThickness; var k = l.dataPoints, n = "solid"; if (d.setLineDash) { var m = F(l.nullDataLineDashType, l.lineThickness), n = l.lineDashType, p = F(n, l.lineThickness); d.setLineDash(p) } var e = l.id; this._eventManager.objectMap[e] = {
                    objectType: "dataSeries",
                    dataSeriesIndex: h
                }; e = D(e); b.strokeStyle = e; b.lineWidth = 0 < l.lineThickness ? Math.max(l.lineThickness, 4) : 0; var e = l._colorSet, r = e = l.lineColor = l.options.lineColor ? l.options.lineColor : e[0]; d.strokeStyle = e; var q = !0, s = 0, u, w; d.beginPath(); if (0 < k.length) {
                    for (var y = !1, s = 0; s < k.length; s++) if (u = k[s].x.getTime ? k[s].x.getTime() : k[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y))) if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y =
                    !0; else {
                        u = a.axisX.convertValueToPixel(u); w = a.axisY.convertValueToPixel(k[s].y); var t = l.dataPointIds[s]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: s, x1: u, y1: w }; q || y ? (!q && l.connectNullData ? (d.setLineDash && (l.options.nullDataLineDashType || n === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (d.stroke(), n = l.nullDataLineDashType, d.setLineDash(m)), d.lineTo(u, w), v && b.lineTo(u, w)) : (d.beginPath(), d.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y =
                        q = !1) : (d.lineTo(u, w), v && b.lineTo(u, w), 0 == s % 500 && (d.stroke(), d.beginPath(), d.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w)))); s < k.length - 1 && (r !== (k[s].lineColor || e) || n !== (k[s].lineDashType || l.lineDashType)) && (d.stroke(), d.beginPath(), d.moveTo(u, w), r = k[s].lineColor || e, d.strokeStyle = r, d.setLineDash && (k[s].lineDashType ? (n = k[s].lineDashType, d.setLineDash(F(n, l.lineThickness))) : (n = l.lineDashType, d.setLineDash(p)))); if (0 < k[s].markerSize || 0 < l.markerSize) {
                            var C = l.getMarkerProperties(s, u, w, d), f = C.color;
                            c.push(C); t = D(t); v && c.push({ x: u, y: w, ctx: b, type: C.type, size: C.size, color: t, borderColor: t, borderThickness: C.borderThickness })
                        } (k[s].indexLabel || l.indexLabel || k[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: k[s], dataSeries: l, point: { x: u, y: w }, direction: 0 > k[s].y === a.axisY.reversed ? 1 : -1, color: e })
                    } d.stroke(); v && b.stroke()
                }
            } O.drawMarkers(c); l.markerColor = f; d.restore(); d.beginPath(); v && b.beginPath(); return {
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = this._eventManager.ghostCtx; d.save(); var c = this.plotArea; d.beginPath(); d.rect(c.x1, c.y1, c.width, c.height); d.clip(); for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                var h = a.dataSeriesIndexes[g], l = this.data[h]; d.lineWidth = l.lineThickness; var k = l.dataPoints, n = "solid"; if (d.setLineDash) {
                    ...
                    n = l.lineDashType, p = F(n, l.lineThickness); d.setLineDash(p)
                } var e = l.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: h }; e = D(e); b.strokeStyle = e; b.lineWidth = 0 < l.lineThickness ? Math.max(l.lineThickness, 4) : 0; var e = l._colorSet, r = e = l.lineColor = l.options.lineColor ? l.options.lineColor : e[0]; d.strokeStyle = e; var q = !0, s = 0, u, w; d.beginPath(); if (0 < k.length) {
                    ...
                    (!l.connectNullData || !y))) if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0; else {
                        ...
                        (n = k[s].lineDashType, d.setLineDash(F(n, l.lineThickness))) : (n = l.lineDashType, d.setLineDash(p)))); if (0 < k[s].markerSize || 0 < l.markerSize) t = l.getMarkerProperties(s, u, w, d), f = t.color, c.push(t), C = D(C), v && c.push({ x: u, y: w, ctx: b, type: t.type, size: t.size, color: C, borderColor: C, borderThickness: t.borderThickness }); (k[s].indexLabel || l.indexLabel || k[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stepLine", dataPoint: k[s], dataSeries: l, point: { x: u, y: w }, direction: 0 > k[s].y === a.axisY.reversed ?
                            1 : -1, color: e
                        })
                    } d.stroke(); v && b.stroke()
                }
            } O.drawMarkers(c); l.markerColor = f; d.restore(); d.beginPath(); v && b.beginPath(); return { source: d, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; z.prototype.renderSpline = function (a) {
        function d(a) {
            a = wa(a, 2); if (0 < a.length) {
                b.beginPath(); v && c.beginPath(); b.moveTo(a[0].x, a[0].y); a[0].newStrokeStyle && (b.strokeStyle = a[0].newStrokeStyle); a[0].newLineDashArray && b.setLineDash(a[0].newLineDashArray); v && c.moveTo(a[0].x,
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx; b.save(); var f = this.plotArea; b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h], k = this.data[l]; b.lineWidth = k.lineThickness; var n = k.dataPoints, m = "solid"; if (b.setLineDash) { var p = F(k.nullDataLineDashType, k.lineThickness), m = k.lineDashType, e = F(m, k.lineThickness); b.setLineDash(e) } var r = k.id; this._eventManager.objectMap[r] =
                ...
                y.length && (k.options.nullDataLineDashType || !n[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (d(y), y = [])), w = !0; else {
                    u = a.axisX.convertValueToPixel(u); w = a.axisY.convertValueToPixel(n[s].y); var t = k.dataPointIds[s]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: s, x1: u, y1: w }; y[y.length] = { x: u, y: w }; s < n.length - 1 && (q !== (n[s].lineColor || r) || m !== (n[s].lineDashType || k.lineDashType)) && (q = n[s].lineColor || r, y[y.length - 1].newStrokeStyle =
                    q, b.setLineDash && (n[s].lineDashType ? (m = n[s].lineDashType, y[y.length - 1].newLineDashArray = F(m, k.lineThickness)) : (m = k.lineDashType, y[y.length - 1].newLineDashArray = e))); if (0 < n[s].markerSize || 0 < k.markerSize) { var C = k.getMarkerProperties(s, u, w, b), g = C.color; f.push(C); t = D(t); v && f.push({ x: u, y: w, ctx: c, type: C.type, size: C.size, color: t, borderColor: t, borderThickness: C.borderThickness }) } (n[s].indexLabel || k.indexLabel || n[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                        chartType: "spline", dataPoint: n[s],
                        dataSeries: k, point: { x: u, y: w }, direction: 0 > n[s].y === a.axisY.reversed ? 1 : -1, color: r
                    }); w = !1
                } d(y)
            } O.drawMarkers(f); k.markerColor = g; b.restore(); b.beginPath(); v && c.beginPath(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; var R = function (a, d, b, c, f, g, h, l, k, n, m, p, e) {
        "undefined" === typeof e && (e = 1); h = h || 0; l = l || "black"; var r = 15 < c - d && 15 < f - b ? 8 : 0.35 * Math.min(c - d, f - b); a.beginPath(); a.moveTo(d, b); a.save(); a.fillStyle = g; a.globalAlpha = e; a.fillRect(d,
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                var n = a.dataSeriesIndexes[c], p = this.data[n], e = p.dataPoints; if (0 < e.length) for (var r = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++) if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                    g = a.axisX.convertValueToPixel(l); h = a.axisY.convertValueToPixel(e[f].y); g = a.axisX.reversed ? g + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + c) * m << 0 : g - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount +
                    ...
                    this._indexLabels.push({ chartType: "column", dataPoint: e[f], dataSeries: p, point: { x: g + (q - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? h : s }, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: g, y1: Math.min(h, s), x2: q, y2: Math.max(h, s) }, color: b })
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); a = Math.min(k, a.axisY.bounds.y2); return { source: d, dest: this.plotArea.ctx, animationCallback: E.yScaleAnimation, easingFunction: E.easing.easeOutQuart, animationBase: a }
        }
        ...
        this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], r = this.data[e], q = r.dataPoints; if (0 < q.length) {
                    var s = 5 < p && r.bevelEnabled ? !0 : !1; d.strokeStyle = "#4572A7 "; for (l = 0; l < q.length; l++) if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), u = c - a.plotType.plotUnits.length * p /
                        2 + a.index * p << 0, w = u + p << 0, y; if (a.axisY.logarithmic) h[b] = q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : n, f[b] = k); else if (k = a.axisY.convertValueToPixel(q[l].y), 0 <= q[l].y) { var t = f[b] ? f[b] : 0; k -= t; y = n - t; f[b] = t + (y - k) } else t = g[b] ? g[b] : 0, y = k + t, k = n + t, g[b] = t + (y - k); b = q[l].color ? q[l].color : r._colorSet[l % r._colorSet.length]; R(d, u, k, w, y, b, 0, null, s && 0 <= q[l].y, 0 > q[l].y && s, !1, !1, r.fillOpacity); b = r.dataPointIds[l]; this._eventManager.objectMap[b] = {
            ...
            } d.restore(); v && this._eventManager.ghostCtx.restore(); a = Math.min(n, a.axisY.bounds.y2); return {
                source: d,
                dest: this.plotArea.ctx, animationCallback: E.yScaleAnimation, easingFunction: E.easing.easeOutQuart, animationBase: a
            }
        }
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            -Infinity, l)); p < l && (p = l); p > m && (p = m); d.save(); v && this._eventManager.ghostCtx.save(); d.beginPath(); d.rect(c.x1, c.y1, c.width, c.height); d.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], r = this.data[e], q = r.dataPoints; if (0 < q.length) for (var s = 5 < p && r.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++) if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin ||
                b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                    c = a.axisX.convertValueToPixel(b); k = 0 !== a.dataPointYSums[b] ? 100 * (q[l].y / a.dataPointYSums[b]) : 0; var u = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = u + p << 0, y; if (a.axisY.logarithmic) { h[b] = k + (h[b] ? h[b] : 0); if (0 >= h[b]) continue; k = a.axisY.convertValueToPixel(h[b]); y = f[b] ? f[b] : n; f[b] = k } else if (k = a.axisY.convertValueToPixel(k), 0 <= q[l].y) { var t = f[b] ? f[b] : 0; k -= t; y = n - t; f[b] = t + (y - k) } else t = g[b] ? g[b] : 0, y = k + t, k = n + t, g[b] = t + (y - k); b = q[l].color ? q[l].color :
                    r._colorSet[l % r._colorSet.length]; R(d, u, k, w, y, b, 0, null, s && 0 <= q[l].y, 0 > q[l].y && s, !1, !1, r.fillOpacity); b = r.dataPointIds[l]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: l, x1: u, y1: k, x2: w, y2: y }; b = D(b); v && R(this._eventManager.ghostCtx, u, k, w, y, b, 0, null, !1, !1, !1, !1); (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        chartType: "stackedColumn100", dataPoint: q[l], dataSeries: r, point: { x: c, y: 0 <= q[l].y ? k : y }, direction: 0 >
                        q[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: u, y1: Math.min(k, y), x2: w, y2: Math.max(k, y) }, color: b
                    })
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); a = Math.min(n, a.axisY.bounds.y2); return { source: d, dest: this.plotArea.ctx, animationCallback: E.yScaleAnimation, easingFunction: E.easing.easeOutQuart, animationBase: a }
        }
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                var n = a.dataSeriesIndexes[c], p = this.data[n], e = p.dataPoints; if (0 < e.length) {
                    var r = 5 < m && p.bevelEnabled ? !0 : !1; d.strokeStyle = "#4572A7 "; for (f = 0; f < e.length; f++) if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                        h = a.axisX.convertValueToPixel(l); g = a.axisY.convertValueToPixel(e[f].y); h = a.axisX.reversed ? h + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + c) * m << 0 : h - a.plotType.totalDataSeries *
                        m / 2 + (a.previousDataSeriesCount + c) * m << 0; var q = a.axisX.reversed ? h - m << 0 : h + m << 0, s; 0 <= e[f].y ? s = k : (s = g, g = k); b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length]; R(d, s, h, g, q, b, 0, null, r, !1, !1, !1, p.fillOpacity); b = p.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: s, y1: h, x2: g, y2: q }; b = D(b); v && R(this._eventManager.ghostCtx, s, h, g, q, b, 0, null, !1, !1, !1, !1); (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "bar",
                            dataPoint: e[f], dataSeries: p, point: { x: 0 <= e[f].y ? g : s, y: h + (q - h) / 2 }, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, g), y1: h, x2: Math.max(s, g), y2: q }, color: b
                        })
                    }
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); a = Math.max(k, a.axisX.bounds.x2); return { source: d, dest: this.plotArea.ctx, animationCallback: E.xScaleAnimation, easingFunction: E.easing.easeOutQuart, animationBase: a }
        }
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.height), this._eventManager.ghostCtx.clip()); for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], r = this.data[e], q = r.dataPoints; if (0 < q.length) {
                    var s = 5 < p && r.bevelEnabled ? !0 : !1; d.strokeStyle = "#4572A7 "; for (l = 0; l < q.length; l++) if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), u = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = u + p << 0, y; if (a.axisY.logarithmic) h[b] =
                        ...
                        y, u, k, w, b, 0, null, !1, !1, !1, !1); (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: q[l], dataSeries: r, point: { x: 0 <= q[l].y ? k : y, y: c }, direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(y, k), y1: u, x2: Math.max(y, k), y2: w }, color: b })
                    }
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); a = Math.max(n, a.axisX.bounds.x2); return {
                source: d, dest: this.plotArea.ctx, animationCallback: E.xScaleAnimation, easingFunction: E.easing.easeOutQuart,
                animationBase: a
            }
        }
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            d.rect(c.x1, c.y1, c.width, c.height); d.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], r = this.data[e], q = r.dataPoints; if (0 < q.length) {
                    var s = 5 < p && r.bevelEnabled ? !0 : !1; d.strokeStyle = "#4572A7 "; for (l = 0; l < q.length; l++) if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                    typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), u; u = 0 !== a.dataPointYSums[b] ? 100 * (q[l].y / a.dataPointYSums[b]) : 0; var w = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, y = w + p << 0; if (a.axisY.logarithmic) { h[b] = u + (h[b] ? h[b] : 0); if (0 >= h[b]) continue; u = f[b] ? f[b] : n; f[b] = k = a.axisY.convertValueToPixel(h[b]) } else if (k = a.axisY.convertValueToPixel(u), 0 <= q[l].y) { var t = f[b] ? f[b] : 0; u = n + t; k += t; f[b] = t + (k - u) } else t = g[b] ? g[b] : 0, u = k - t, k = n - t, g[b] = t + (k - u); b = q[l].color ? q[l].color : r._colorSet[l % r._colorSet.length]; R(d, u, w,
                        k, y, b, 0, null, s, !1, !1, !1, r.fillOpacity); b = r.dataPointIds[l]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: l, x1: u, y1: w, x2: k, y2: y }; b = D(b); v && R(this._eventManager.ghostCtx, u, w, k, y, b, 0, null, !1, !1, !1, !1); (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stackedBar100", dataPoint: q[l], dataSeries: r, point: { x: 0 <= q[l].y ? k : u, y: c }, direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1, bounds: {
                                x1: Math.min(u, k),
            ...
            } d.restore(); v && this._eventManager.ghostCtx.restore(); a = Math.max(n, a.axisX.bounds.x2); return { source: d, dest: this.plotArea.ctx, animationCallback: E.xScaleAnimation, easingFunction: E.easing.easeOutQuart, animationBase: a }
        }
        ...
        function d() {
            ...
            b.lineTo(t.x, y), b.closePath(), b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, v && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = { x: q, y: s })
        } var b = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.rect(k.x1, k.y1, k.width, k.height), c.clip()); for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, h = m.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: n }; h = D(h); c.fillStyle = h; var h = [], e = !0, r = 0, q, s, u, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, t = null; if (0 < p.length) {
                    var C = m._colorSet[r % m._colorSet.length], x = m.lineColor = m.options.lineColor || C, ca = x; b.fillStyle = C; b.strokeStyle = x; b.lineWidth = m.lineThickness;
                    var z = "solid"; if (b.setLineDash) { var A = F(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, K = F(z, m.lineThickness); b.setLineDash(K) } for (var I = !0; r < p.length; r++) if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !I))) if ("number" !== typeof p[r].y) m.connectNullData || (I || e) || d(), I = !0; else {
                        q = a.axisX.convertValueToPixel(u); s = a.axisY.convertValueToPixel(p[r].y); e || I ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType ||
                        ...
                        b.setLineDash(K)))); var G = m.dataPointIds[r]; this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: r, x1: q, y1: s }; 0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < m.markerSize) && (u = m.getMarkerProperties(r, q, s, b), l = u.color, h.push(u), G = D(G), v && h.push({ x: q, y: s, ctx: c, type: u.type, size: u.size, color: G, borderColor: G, borderThickness: u.borderThickness })); (p[r].indexLabel || m.indexLabel || p[r].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "area",
                            dataPoint: p[r], dataSeries: m, point: { x: q, y: s }, direction: 0 > p[r].y === a.axisY.reversed ? 1 : -1, color: C
                        })
                    } d(); O.drawMarkers(h); m.markerColor = l
                }
            } b.restore(); v && this._eventManager.ghostCtx.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; z.prototype.renderSplineArea = function (a) {
        function d() {
            var d = wa(y, 2); if (0 < d.length) {
                if (0 < m.lineThickness) {
                    b.beginPath(); b.moveTo(d[0].x, d[0].y); d[0].newStrokeStyle && (b.strokeStyle = d[0].newStrokeStyle);
                    d[0].newLineDashArray && b.setLineDash(d[0].newLineDashArray); for (var e = 0; e < d.length - 3; e += 3) if (b.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), v && c.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle || d[e + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle && (b.strokeStyle = d[e + 3].newStrokeStyle), d[e + 3].newLineDashArray && b.setLineDash(d[e + 3].newLineDashArray); b.stroke()
                } b.beginPath(); b.moveTo(d[0].x,
                ...
                1; v && (c.lineTo(d[d.length - 1].x, u), c.lineTo(w.x, u), c.closePath(), c.fill())
            }
        } var b = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, h = [], l = null, k = this.plotArea; b.save(); v && c.save(); b.beginPath(); b.rect(k.x1, k.y1, k.width, k.height); b.clip(); v && (c.beginPath(), c.rect(k.x1, k.y1, k.width, k.height), c.clip()); for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints,
                h = m.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: n }; h = D(h); c.fillStyle = h; var h = [], e = 0, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u, w = null, y = []; if (0 < p.length) {
                    var t = m._colorSet[e % m._colorSet.length], C = m.lineColor = m.options.lineColor || t, x = C; b.fillStyle = t; b.strokeStyle = C; b.lineWidth = m.lineThickness; var z = "solid"; if (b.setLineDash) { var A = F(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, Q = F(z, m.lineThickness); b.setLineDash(Q) } for (q =
                    !1; e < p.length; e++) if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q))) if ("number" !== typeof p[e].y) 0 < e && !q && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, z = m.nullDataLineDashType) : (d(), y = [])), q = !0; else {
                        r = a.axisX.convertValueToPixel(r); q = a.axisY.convertValueToPixel(p[e].y); var K = m.dataPointIds[e]; this._eventManager.objectMap[K] =
                        { id: K, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: r, y1: q }; y[y.length] = { x: r, y: q }; e < p.length - 1 && (x !== (p[e].lineColor || C) || z !== (p[e].lineDashType || m.lineDashType)) && (x = p[e].lineColor || C, y[y.length - 1].newStrokeStyle = x, b.setLineDash && (p[e].lineDashType ? (z = p[e].lineDashType, y[y.length - 1].newLineDashArray = F(z, m.lineThickness)) : (z = m.lineDashType, y[y.length - 1].newLineDashArray = Q))); if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize)) {
                            ...
                            h.push(I); K = D(K); v && h.push({ x: r, y: q, ctx: c, type: I.type, size: I.size, color: K, borderColor: K, borderThickness: I.borderThickness })
                        } (p[e].indexLabel || m.indexLabel || p[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: p[e], dataSeries: m, point: { x: r, y: q }, direction: 0 > p[e].y === a.axisY.reversed ? 1 : -1, color: t }); q = !1
                    } d(); O.drawMarkers(h); m.markerColor = l
                }
            } b.restore(); v && this._eventManager.ghostCtx.restore(); return {
                ...
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, h = m.id; this._eventManager.objectMap[h] = {
                    ...
                    p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !C))) {
                        ...
                        b.moveTo(q, s), v && (c.beginPath(), c.moveTo(q, s)), t = { x: q, y: s }), C = e = !1) : (b.lineTo(q, G), v && c.lineTo(q, G), b.lineTo(q, s), v && c.lineTo(q, s), 0 == r % 250 && d()), r < p.length - 1 && (A !== (p[r].lineColor || z) || Q !== (p[r].lineDashType || m.lineDashType)) && (d(), A = p[r].lineColor || z, b.strokeStyle = A, b.setLineDash && (p[r].lineDashType ? (Q = p[r].lineDashType, b.setLineDash(F(Q, m.lineThickness))) : (Q = m.lineDashType, b.setLineDash(I)))), G = m.dataPointIds[r], this._eventManager.objectMap[G] = {
                            ...
                            x1: q, y1: s
                        }, 0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < m.markerSize) && (u = m.getMarkerProperties(r, q, s, b), l = u.color, h.push(u), G = D(G), v && h.push({ x: q, y: s, ctx: c, type: u.type, size: u.size, color: G, borderColor: G, borderThickness: u.borderThickness })), (p[r].indexLabel || m.indexLabel || p[r].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepArea", dataPoint: p[r], dataSeries: m, point: { x: q, y: s }, direction: 0 > p[r].y === a.axisY.reversed ? 1 : -1, color: x }))
                    } d(); O.drawMarkers(h); m.markerColor = l
                }
            } b.restore();
            v && this._eventManager.ghostCtx.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; z.prototype.renderStackedArea = function (a) {
        function d() { if (!(1 > k.length)) { for (0 < t.lineThickness && b.stroke() ; 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); v && u.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = t.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); v && (u.closePath(), u.fill(), u.beginPath()); k = [] } } var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = [], g = null, h = this.plotArea, l = [], k = [], n = [], m = [], p = 0, e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u = this._eventManager.ghostCtx; v && u.beginPath(); b.save(); v && u.save(); b.beginPath(); b.rect(h.x1, h.y1, h.width, h.height); b.clip(); v && (u.beginPath(), u.rect(h.x1, h.y1, h.width, h.height), u.clip()); for (var w = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var y = a.dataSeriesIndexes[h], t = this.data[y], C = t.dataPoints; t.dataPointIndexes =
                []; for (p = 0; p < C.length; p++) y = C[p].x.getTime ? C[p].x.getTime() : C[p].x, t.dataPointIndexes[y] = p, w[y] || (n.push(y), w[y] = !0); n.sort(Aa)
            } for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                y = a.dataSeriesIndexes[h]; t = this.data[y]; C = t.dataPoints; w = !0; k = []; p = t.id; this._eventManager.objectMap[p] = { objectType: "dataSeries", dataSeriesIndex: y }; p = D(p); u.fillStyle = p; if (0 < n.length) {
                    var c = t._colorSet[0], x = t.lineColor = t.options.lineColor || c, z = x; b.fillStyle = c; b.strokeStyle = x; b.lineWidth = t.lineThickness; var A = "solid"; if (b.setLineDash) {
                        var Q =
                        F(t.nullDataLineDashType, t.lineThickness), A = t.lineDashType, K = F(A, t.lineThickness); b.setLineDash(K)
                    } for (var I = !0, p = 0; p < n.length; p++) {
                        q = n[p]; var G = null, G = 0 <= t.dataPointIndexes[q] ? C[t.dataPointIndexes[q]] : { x: q, y: null }; if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I))) if ("number" !== typeof G.y) t.connectNullData || (I || w) || d(), I = !0; else {
                            e = a.axisX.convertValueToPixel(q); var ga = l[q] ? l[q] : 0; if (a.axisY.logarithmic) { m[q] = G.y + (m[q] ? m[q] : 0); if (0 >= m[q]) continue; r = a.axisY.convertValueToPixel(m[q]) } else r =
                            ...
                            (0 < G.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b), g = q.color, f.push(q), markerColor = D(ha), v && f.push({ x: e, y: r, ctx: u, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness })); (G.indexLabel || t.indexLabel || G.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: G, dataSeries: t, point: { x: e, y: r }, direction: 0 > C[p].y === a.axisY.reversed ? 1 : -1, color: c })
                        }
                    } d(); b.moveTo(e, r); v && u.moveTo(e, r)
                } delete t.dataPointIndexes;
                t.markerColor = g
            } O.drawMarkers(f); b.restore(); v && u.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; z.prototype.renderStackedArea100 = function (a) {
        function d() { for (0 < t.lineThickness && b.stroke() ; 0 < k.length;) { var a = k.pop(); b.lineTo(a.x, a.y); v && u.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = t.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); v && (u.closePath(), u.fill(), u.beginPath()); k = [] } var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = this.plotArea, g = [], h = null, l = [], k = [], n = [], m = [], p = 0, e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u = this._eventManager.ghostCtx; b.save(); v && u.save(); b.beginPath(); b.rect(f.x1, f.y1, f.width, f.height); b.clip(); v && (u.beginPath(), u.rect(f.x1, f.y1, f.width, f.height), u.clip()); for (var w = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                var y = a.dataSeriesIndexes[f], t = this.data[y], x = t.dataPoints; t.dataPointIndexes = []; for (p = 0; p < x.length; p++) y =
                x[p].x.getTime ? x[p].x.getTime() : x[p].x, t.dataPointIndexes[y] = p, w[y] || (n.push(y), w[y] = !0); n.sort(Aa)
            } for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                y = a.dataSeriesIndexes[f]; t = this.data[y]; x = t.dataPoints; w = !0; c = t.id; this._eventManager.objectMap[c] = { objectType: "dataSeries", dataSeriesIndex: y }; c = D(c); u.fillStyle = c; k = []; if (0 < n.length) {
                    var c = t._colorSet[p % t._colorSet.length], z = t.lineColor = t.options.lineColor || c, A = z; b.fillStyle = c; b.strokeStyle = z; b.lineWidth = t.lineThickness; var T = "solid"; if (b.setLineDash) {
                        var Q =
                        F(t.nullDataLineDashType, t.lineThickness), T = t.lineDashType, K = F(T, t.lineThickness); b.setLineDash(K)
                    } for (var I = !0, p = 0; p < n.length; p++) {
                        q = n[p]; var G = null, G = 0 <= t.dataPointIndexes[q] ? x[t.dataPointIndexes[q]] : { x: q, y: null }; if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I))) if ("number" !== typeof G.y) t.connectNullData || (I || w) || d(), I = !0; else {
                            var ga; ga = 0 !== a.dataPointYSums[q] ? 100 * (G.y / a.dataPointYSums[q]) : 0; e = a.axisX.convertValueToPixel(q); var ha = l[q] ? l[q] : 0; if (a.axisY.logarithmic) {
                                m[q] =
                                ga + (m[q] ? m[q] : 0); if (0 >= m[q]) continue; r = a.axisY.convertValueToPixel(m[q])
                            } else r = a.axisY.convertValueToPixel(ga), r -= ha; k.push({ x: e, y: s - ha }); l[q] = s - r; w || I ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || T === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), T = t.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), I = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e,
                            r), v && u.moveTo(e, r), k.push({ x: e, y: s - ha }))); p < x.length - 1 && (A !== (x[p].lineColor || z) || T !== (x[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), k.push({ x: e, y: s - ha }), A = x[p].lineColor || z, b.strokeStyle = A, b.setLineDash && (x[p].lineDashType ? (T = x[p].lineDashType, b.setLineDash(F(T, t.lineThickness))) : (T = t.lineDashType, b.setLineDash(K)))); if (0 <= t.dataPointIndexes[q]) {
                                var Ga = t.dataPointIds[t.dataPointIndexes[q]]; this._eventManager.objectMap[Ga] = {
                                    id: Ga, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: t.dataPointIndexes[q],
                                    x1: e, y1: r
                                }
                            } 0 <= t.dataPointIndexes[q] && 0 !== G.markerSize && (0 < G.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b), h = q.color, g.push(q), markerColor = D(Ga), v && g.push({ x: e, y: r, ctx: u, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness })); (G.indexLabel || t.indexLabel || G.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: G, dataSeries: t, point: { x: e, y: r }, direction: 0 > x[p].y === a.axisY.reversed ? 1 : -1, color: c })
                        }
                    } d();
                    b.moveTo(e, r); v && u.moveTo(e, r)
                } delete t.dataPointIndexes; t.markerColor = h
            } O.drawMarkers(g); b.restore(); v && u.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; z.prototype.renderBubble = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = this.plotArea, c = 0, f, g; d.save(); v && this._eventManager.ghostCtx.save(); d.beginPath(); d.rect(b.x1, b.y1, b.width, b.height); d.clip(); v && (this._eventManager.ghostCtx.beginPath(),
            ...
            r), k = 0; k < a.dataSeriesIndexes.length; k++) if (n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, 0 < p.length) for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++) if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[c].y) {
                f = a.axisX.convertValueToPixel(f); g = a.axisY.convertValueToPixel(p[c].y); var e = p[c].z, q = 2 * Math.max(Math.sqrt((h === l ? b / 2 : r + (b - r) / (h - l) * (e - l)) / Math.PI) << 0, 1), e = m.getMarkerProperties(c, d); e.size = q; d.globalAlpha =
                m.fillOpacity; O.drawMarker(f, g, d, e.type, e.size, e.color, e.borderColor, e.borderThickness); d.globalAlpha = 1; var s = m.dataPointIds[c]; this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: c, x1: f, y1: g, size: q }; q = D(s); v && O.drawMarker(f, g, this._eventManager.ghostCtx, e.type, e.size, q, q, e.borderThickness); (p[c].indexLabel || m.indexLabel || p[c].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                    chartType: "bubble", dataPoint: p[c], dataSeries: m, point: { x: f, y: g },
                    direction: 1, bounds: { x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2 }, color: null
                })
            } d.restore(); v && this._eventManager.ghostCtx.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: E.fadeInAnimation, easingFunction: E.easing.easeInQuad, animationBase: 0 }
        }
    }; z.prototype.renderScatter = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = this.plotArea, c = 0, f, g; d.save(); v && this._eventManager.ghostCtx.save(); d.beginPath(); d.rect(b.x1, b.y1, b.width,
            b.height); d.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h], k = this.data[l], n = k.dataPoints; if (0 < n.length) {
                    d.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2); for (var m = 0, p = 0, c = 0; c < n.length; c++) if (f = n[c].getTime ? f = n[c].x.getTime() : f = n[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" ===
                    typeof n[c].y) {
                        f = a.axisX.convertValueToPixel(f); g = a.axisY.convertValueToPixel(n[c].y); var e = k.getMarkerProperties(c, f, g, d); d.globalAlpha = k.fillOpacity; O.drawMarker(e.x, e.y, e.ctx, e.type, e.size, e.color, e.borderColor, e.borderThickness); d.globalAlpha = 1; Math.sqrt((m - f) * (m - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (m = k.dataPointIds[c], this._eventManager.objectMap[m] = { id: m, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: c, x1: f, y1: g }, m = D(m), v &&
                        O.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, m, m, e.borderThickness), (n[c].indexLabel || k.indexLabel || n[c].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: n[c], dataSeries: k, point: { x: f, y: g }, direction: 1, bounds: { x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2 }, color: null }), m = f, p = g)
                    }
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); return {
                source: d, dest: this.plotArea.ctx, animationCallback: E.fadeInAnimation, easingFunction: E.easing.easeInQuad,
                animationBase: 0
            }
        }
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                var r = a.dataSeriesIndexes[e], q = this.data[r], s = q.dataPoints; if (0 < s.length) for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++) if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                    g = a.axisX.convertValueToPixel(m); h = a.axisY.convertValueToPixel(s[f].y[0]);
                    ...
                    h), d.lineTo(w, h), d.stroke(), d.beginPath(), d.moveTo(g, n), d.lineTo(y, n), d.stroke(), v && (c = D(z), b.strokeStyle = c, b.moveTo(g - x, l), b.lineTo(g - x, k), b.stroke(), b.beginPath(), b.moveTo(g, h), b.lineTo(w, h), b.stroke(), b.beginPath(), b.moveTo(g, n), b.lineTo(y, n), b.stroke())); (s[f].indexLabel || q.indexLabel || s[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                        chartType: q.type, dataPoint: s[f], dataSeries: q, point: { x: w + (y - w) / 2, y: a.axisY.reversed ? k : l }, direction: 1, bounds: {
                            x1: w, y1: Math.min(l, k), x2: y, y2: Math.max(l,
                            k)
                        }, color: c
                    })
                }
            } d.restore(); v && b.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: E.fadeInAnimation, easingFunction: E.easing.easeInQuad, animationBase: 0 }
        }
        ...
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            g && (l = g); d.save(); v && this._eventManager.ghostCtx.save(); d.beginPath(); d.rect(c.x1, c.y1, c.width, c.height); d.clip(); v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints; if (0 < p.length) for (var e = 5 < l && m.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++) if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin ||
                h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                    b = a.axisX.convertValueToPixel(h); c = a.axisY.convertValueToPixel(p[f].y[0]); g = a.axisY.convertValueToPixel(p[f].y[1]); var r = a.axisX.reversed ? b + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + k) * l << 0 : b - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + k) * l << 0, q = a.axisX.reversed ? r - l << 0 : r + l << 0, b = p[f].color ? p[f].color : m._colorSet[f % m._colorSet.length]; if (c > g) {
                        var s = c,
                        c = g; g = s
                    } s = m.dataPointIds[f]; this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: r, y1: c, x2: q, y2: g }; R(d, r, c, q, g, b, 0, b, e, e, !1, !1, m.fillOpacity); b = D(s); v && R(this._eventManager.ghostCtx, r, c, q, g, b, 0, null, !1, !1, !1, !1); if (p[f].indexLabel || m.indexLabel || p[f].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({
                        chartType: "rangeColumn", dataPoint: p[f], dataSeries: m, indexKeyword: 0, point: { x: r + (q - r) / 2, y: p[f].y[1] >= p[f].y[0] ? g : c }, direction: p[f].y[1] >= p[f].y[0] ?
                        -1 : 1, bounds: { x1: r, y1: Math.min(c, g), x2: q, y2: Math.max(c, g) }, color: b
                    }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: p[f], dataSeries: m, indexKeyword: 1, point: { x: r + (q - r) / 2, y: p[f].y[1] >= p[f].y[0] ? c : g }, direction: p[f].y[1] >= p[f].y[0] ? 1 : -1, bounds: { x1: r, y1: Math.min(c, g), x2: q, y2: Math.max(c, g) }, color: b })
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: E.fadeInAnimation, easingFunction: E.easing.easeInQuad, animationBase: 0 }
        }
    ...
    function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            this._eventManager.ghostCtx.rect(c.x1, c.y1, c.width, c.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = a.dataSeriesIndexes[n], p = this.data[m], e = p.dataPoints; if (0 < e.length) {
                    var r = 5 < k && p.bevelEnabled ? !0 : !1; d.strokeStyle = "#4572A7 "; for (f = 0; f < e.length; f++) if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                        c = a.axisY.convertValueToPixel(e[f].y[0]);
                        g = a.axisY.convertValueToPixel(e[f].y[1]); h = a.axisX.convertValueToPixel(l); h = a.axisX.reversed ? h + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : h - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + n) * k << 0; var q = a.axisX.reversed ? h - k << 0 : h + k << 0; c > g && (b = c, c = g, g = b); b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length]; R(d, c, h, g, q, b, 0, null, r, !1, !1, !1, p.fillOpacity); b = p.dataPointIds[f]; this._eventManager.objectMap[b] = {
                            ...
                            chartType: "rangeBar", dataPoint: e[f], dataSeries: p, indexKeyword: 1, point: {
                                x: e[f].y[1] >=
                                e[f].y[0] ? g : c, y: h + (q - h) / 2
                            }, direction: e[f].y[1] >= e[f].y[0] ? 1 : -1, bounds: { x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: q }, color: b
                        })
                    }
                }
            } d.restore(); v && this._eventManager.ghostCtx.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: E.fadeInAnimation, easingFunction: E.easing.easeInQuad, animationBase: 0 }
        ...
        function d() {
            if (w) {
                var a = null; 0 < n.lineThickness && b.stroke(); for (var d = l.length - 1; 0 <= d; d--) a = l[d], b.lineTo(a.x, a.y), c.lineTo(a.x, a.y); b.closePath(); b.globalAlpha =
                n.fillOpacity; b.fill(); b.globalAlpha = 1; c.fill(); if (0 < n.lineThickness) { b.beginPath(); b.moveTo(a.x, a.y); for (d = 0; d < l.length; d++) a = l[d], b.lineTo(a.x, a.y); b.stroke() } b.beginPath(); b.moveTo(r, q); c.beginPath(); c.moveTo(r, q); w = { x: r, y: q }; l = []; l.push({ x: r, y: s })
            }
        } var b = a.targetCanvasCtx || this.plotArea.ctx; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            h.y1, h.width, h.height), c.clip()); for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = [], k = a.dataSeriesIndexes[h], n = this.data[k], m = n.dataPoints, f = n.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: k }; f = D(f); c.fillStyle = f; var f = [], p = !0, e = 0, r, q, s, u, w = null; if (0 < m.length) {
                    var y = n._colorSet[e % n._colorSet.length], t = n.lineColor = n.options.lineColor || y, x = t; b.fillStyle = y; b.strokeStyle = t; b.lineWidth = n.lineThickness; var z = "solid"; if (b.setLineDash) {
                        var A = F(n.nullDataLineDashType, n.lineThickness),
                        z = n.lineDashType, T = F(z, n.lineThickness); b.setLineDash(T)
                        ...
                        r = a.axisX.convertValueToPixel(u); q = a.axisY.convertValueToPixel(m[e].y[0]); s = a.axisY.convertValueToPixel(m[e].y[1]); p || Q ? (n.connectNullData && !p ? (b.setLineDash && (n.options.nullDataLineDashType ||
                        ...
                        1 && (x !== (m[e].lineColor || t) || z !== (m[e].lineDashType || n.lineDashType)) && (d(), x = m[e].lineColor || t, l[l.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (m[e].lineDashType ? (z = m[e].lineDashType, l[l.length - 1].newLineDashArray = F(z, n.lineThickness), b.setLineDash(l[l.length - 1].newLineDashArray)) : (z = n.lineDashType, l[l.length - 1].newLineDashArray = T, b.setLineDash(T)))); if (0 !== m[e].markerSize && (0 < m[e].markerSize || 0 < n.markerSize)) {
                            var K = n.getMarkerProperties(e, r, s, b); f.push(K); var I = D(u); v && f.push({
                                x: r,
                                y: s, ctx: c, type: K.type, size: K.size, color: I, borderColor: I, borderThickness: K.borderThickness
                            }); K = n.getMarkerProperties(e, r, q, b); g = K.color; f.push(K); I = D(u); v && f.push({ x: r, y: q, ctx: c, type: K.type, size: K.size, color: I, borderColor: I, borderThickness: K.borderThickness })
                        } if (m[e].indexLabel || n.indexLabel || m[e].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: m[e], dataSeries: n, indexKeyword: 0, point: { x: r, y: q }, direction: m[e].y[0] > m[e].y[1] === a.axisY.reversed ? -1 : 1, color: y }),
                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: m[e], dataSeries: n, indexKeyword: 1, point: { x: r, y: s }, direction: m[e].y[0] > m[e].y[1] === a.axisY.reversed ? 1 : -1, color: y })
                    } else Q || p || d(), Q = !0; d(); O.drawMarkers(f); n.markerColor = g
                }
            } b.restore(); v && this._eventManager.ghostCtx.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
    }; z.prototype.renderRangeSplineArea = function (a) {
        function d(a, d) {
            var e = wa(q, 2); if (0 < e.length) {
                ...
                } b.beginPath(); b.moveTo(e[0].x, e[0].y); v && (c.beginPath(), c.moveTo(e[0].x, e[0].y)); for (f = 0; f < e.length - 3; f +=
                3) b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y), v && c.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y); e = wa(s, 2); b.lineTo(s[s.length - 1].x, s[s.length - 1].y); for (f = e.length - 1; 2 < f; f -= 3) b.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y), v && c.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y); b.closePath(); b.globalAlpha = k.fillOpacity; b.fill(); v && (c.closePath(), c.fill()); b.globalAlpha = 1; if (0 < k.lineThickness) {
                    b.strokeStyle =
            ...
            var c =
            this._eventManager.ghostCtx, f = [], g = null, h = this.plotArea; b.save(); v && c.save(); b.beginPath(); b.rect(h.x1, h.y1, h.width, h.height); b.clip(); v && (c.beginPath(), c.rect(h.x1, h.y1, h.width, h.height), c.clip()); for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var l = a.dataSeriesIndexes[h], k = this.data[l], n = k.dataPoints, f = k.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: l }; f = D(f); c.fillStyle = f; var f = [], m = 0, p, e, r, q = [], s = []; if (0 < n.length) {
                    var u = k._colorSet[m % k._colorSet.length], w = k.lineColor =
                    k.options.lineColor || u, y = w; b.fillStyle = u; b.lineWidth = k.lineThickness; var t = "solid", x; if (b.setLineDash) { var z = F(k.nullDataLineDashType, k.lineThickness), t = k.lineDashType; x = F(t, k.lineThickness) } for (e = !1; m < n.length; m++) if (p = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !e))) if (null !== n[m].y && n[m].y.length && "number" === typeof n[m].y[0] && "number" === typeof n[m].y[1]) {
                        p = a.axisX.convertValueToPixel(p); e = a.axisY.convertValueToPixel(n[m].y[0]);
                        ...
                        x))); if (0 !== n[m].markerSize && (0 < n[m].markerSize || 0 < k.markerSize)) { var T = k.getMarkerProperties(m, p, e, b), g = T.color; f.push(T); var Q = D(A); v && f.push({ x: p, y: e, ctx: c, type: T.type, size: T.size, color: Q, borderColor: Q, borderThickness: T.borderThickness }); T = k.getMarkerProperties(m, p, r, b); f.push(T); Q = D(A); v && f.push({ x: p, y: r, ctx: c, type: T.type, size: T.size, color: Q, borderColor: Q, borderThickness: T.borderThickness }) } if (n[m].indexLabel || k.indexLabel || n[m].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({
                            chartType: "splineArea",
                            dataPoint: n[m], dataSeries: k, indexKeyword: 0, point: { x: p, y: e }, direction: n[m].y[0] <= n[m].y[1] ? -1 : 1, color: u
                        }), this._indexLabels.push({ chartType: "splineArea", dataPoint: n[m], dataSeries: k, indexKeyword: 1, point: { x: p, y: r }, direction: n[m].y[0] <= n[m].y[1] ? 1 : -1, color: u }); e = !1
                    } else 0 < m && !e && (k.connectNullData ? b.setLineDash && (0 < q.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = z, t = k.nullDataLineDashType) : (d(x, w), q = [], s = [])), e = !0; d(x, w); O.drawMarkers(f); k.markerColor =
                    g
                }
            } b.restore(); v && this._eventManager.ghostCtx.restore(); return { source: b, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation, easingFunction: E.easing.linear, animationBase: 0 }
        }
        ...
        if (!(0 > b)) {
            "undefined" === typeof l && (l = 1); if (!v) { var n = Number((h % (2 * Math.PI)).toFixed(8)); Number((g % (2 * Math.PI)).toFixed(8)) === n && (h -= 1E-4) } a.save(); a.globalAlpha = l; "pie" === f ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, b, g, h, !1), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(),
            a.fill()) : "doughnut" === f && (a.beginPath(), a.arc(d.x, d.y, b, g, h, !1), 0 <= k && a.arc(d.x, d.y, k * b, h, g, !0), a.closePath(), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.fill()); a.globalAlpha = 1; a.restore()
        }
    }; z.prototype.renderPie = function (a) {
        function d() {
            if (n && m) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < m.length; f++) {
                    var g = m[f], h = n.dataPointIds[f], l = { id: h, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0 }; r.push(l); var p = { percent: null, total: null }, q = null, p = k.getPercentAndTotal(n, g); if (n.indexLabelFormatter ||
                    ...
                    g.indexLabelMaxWidth : n.indexLabelMaxWidth ? n.indexLabelMaxWidth : 0.33 * e.width; l.indexLabelWrap = "undefined" !== typeof g.indexLabelWrap ? g.indexLabelWrap : n.indexLabelWrap; l.startAngle = 0 === f ? n.startAngle ? n.startAngle / 180 * Math.PI : 0 : r[f - 1].endAngle; l.startAngle = (l.startAngle + 2 * Math.PI) % (2 * Math.PI); l.endAngle = l.startAngle + 2 * Math.PI / v * Math.abs(g.y); g = (l.endAngle + l.startAngle) / 2; g = (g + 2 * Math.PI) % (2 * Math.PI); l.midAngle = g; if (l.midAngle > Math.PI / 2 - w && l.midAngle < Math.PI / 2 + w) {
                        if (0 === a || r[c].midAngle > l.midAngle) c = f;
                        a++
                    } else if (l.midAngle > 3 * Math.PI / 2 - w && l.midAngle < 3 * Math.PI / 2 + w) { if (0 === b || r[d].midAngle > l.midAngle) d = f; b++ } l.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right"; l.indexLabelTextBlock = new X(k.plotArea.ctx, {
                        ...
                        1.5 * l.indexLabelFontSize, text: l.indexLabelText, padding: 0, textBaseline: "top"
                    }); l.indexLabelTextBlock.measureText()
                } h = g = 0; p = !1; for (f = 0; f < m.length; f++) l = r[(c + f) % m.length], 1 < a && (l.midAngle > Math.PI / 2 - w && l.midAngle < Math.PI / 2 + w) && (g <= a / 2 && !p ? (l.hemisphere = "right", g++) : (l.hemisphere = "left", p = !0)); p = !1; for (f = 0; f < m.length; f++) l = r[(d + f) % m.length], 1 < b && (l.midAngle > 3 * Math.PI / 2 - w && l.midAngle < 3 * Math.PI / 2 + w) && (h <= b / 2 && !p ? (l.hemisphere = "left", h++) : (l.hemisphere = "right", p = !0))
            }
        } function b(a) {
            var b = k.plotArea.ctx; b.clearRect(e.x1,
            e.y1, e.width, e.height); b.fillStyle = k.backgroundColor; b.fillRect(e.x1, e.y1, e.width, e.height); for (b = 0; b < m.length; b++) {
                var c = r[b].startAngle, d = r[b].endAngle; if (d > c) {
                    var f = 0.07 * A * Math.cos(r[b].midAngle), g = 0.07 * A * Math.sin(r[b].midAngle), l = !1; if (m[b].exploded) { if (1E-9 < Math.abs(r[b].center.x - (t.x + f)) || 1E-9 < Math.abs(r[b].center.y - (t.y + g))) r[b].center.x = t.x + f * a, r[b].center.y = t.y + g * a, l = !0 } else if (0 < Math.abs(r[b].center.x - t.x) || 0 < Math.abs(r[b].center.y - t.y)) r[b].center.x = t.x + f * (1 - a), r[b].center.y = t.y + g * (1 - a),
                    l = !0; l && (f = {}, f.dataSeries = n, f.dataPoint = n.dataPoints[b], f.index = b, k.toolTip.highlightObjects([f])); Ha(k.plotArea.ctx, r[b].center, r[b].radius, m[b].color ? m[b].color : n._colorSet[b % n._colorSet.length], n.type, c, d, n.fillOpacity, r[b].percentInnerRadius)
                }
            } a = k.plotArea.ctx; a.save(); a.fillStyle = "black"; a.strokeStyle = "grey"; a.textBaseline = "middle"; a.lineJoin = "round"; for (b = b = 0; b < m.length; b++) c = r[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !==
            ...
            a.setLineDash && a.setLineDash(F(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, f), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter"); a.save()
        } function c(a, b) {
        ...
        } function f(a) { for (var b = null, d = 1; d < m.length; d++) if (b = (a + d + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) { b = null; break } else if (r[b].indexLabelText && b !== a && (0 > c(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y : r[b].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y))) break; else b = null; return b } function g(a, b, d) {
            d = (d || 0) + 1; if (1E3 < d) return 0; b = b || 0; var e = 0,
            k = t.y - 1 * s, l = t.y + 1 * s; if (0 <= a && a < m.length) {
                var h = r[a]; if (0 > b && h.indexLabelTextBlock.y < k || 0 < b && h.indexLabelTextBlock.y > l) return 0; var n = 0, p = 0, p = n = n = 0; 0 > b ? h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 > k && h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + b < k && (b = -(k - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 + b))) : h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 < k && h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + b > l && (b = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height /
            ...
            var a = k.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline = "middle"; for (var b = a = 0, d = 0, l = !0, b = 0; 10 > b && (1 > b || 0 < d) ; b++) {
                if (n.radius || !n.radius && "undefined" !== typeof n.innerRadius && null !== n.innerRadius && A - d <= E) l = !1; l && (A -= d); d = 0; if ("inside" !== n.indexLabelPlacement) {
                    s = A * u; for (a = 0; a < m.length; a++) {
                        var h =
                        r[a]; h.indexLabelTextBlock.x = t.x + s * Math.cos(h.midAngle); h.indexLabelTextBlock.y = t.y + s * Math.sin(h.midAngle); h.indexLabelAngle = h.midAngle; h.radius = A; h.percentInnerRadius = Q
                    } for (var w, v, a = 0; a < m.length; a++) {
                        var h = r[a], x = f(a); if (null !== x) {
                            w = r[a]; v = r[x]; var z = 0, z = c(w, v) - q; if (0 > z) {
                                for (var C = v = 0, D = 0; D < m.length; D++) D !== a && r[D].hemisphere === h.hemisphere && (r[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? v++ : C++); v = z / (v + C || 1) * C; var C = -1 * (z - v), B = D = 0; "right" === h.hemisphere ? (D = g(a, v), C = -1 * (z - D), B = g(x, C), +B.toFixed(y) <
                ...
                b, c) { for (var d = [], e = 0; d.push(r[b]), b !== c; b = (b + 1 + m.length) % m.length); d.sort(function (a, b) { return a.y - b.y }); for (b = 0; b < d.length; b++) if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText(); else break }; (function () {
            ...
            m = n.dataPoints, p = 10, e = this.plotArea, r = [], q = 2, s, u = 1.3, w = 20 / 180 * Math.PI, y = 6, t = { x: (e.x2 + e.x1) / 2, y: (e.y2 + e.y1) / 2 }, v = 0; a = !1; for (var z = 0; z < m.length; z++) v += Math.abs(m[z].y), !a && ("undefined" !== typeof m[z].indexLabel && null !== m[z].indexLabel && 0 < m[z].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[z].label && null !== m[z].label && 0 < m[z].label.toString().length) && (a = !0); if (0 !== v) {
                ...
                d(); h(); h(); h(); h(); this.disableToolTip = !0; this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                    var b = k.plotArea.ctx; b.clearRect(e.x1, e.y1, e.width, e.height); b.fillStyle = k.backgroundColor; b.fillRect(e.x1, e.y1, e.width, e.height); a = r[0].startAngle + 2 * Math.PI * a; for (b = 0; b < m.length; b++) {
                        var c = 0 === b ? r[b].startAngle : d, d = c + (r[b].endAngle - r[b].startAngle), f = !1; d > a && (d = a, f = !0); var g = m[b].color ? m[b].color : n._colorSet[b % n._colorSet.length]; d > c && Ha(k.plotArea.ctx, r[b].center, r[b].radius,
                        g, n.type, c, d, n.fillOpacity, r[b].percentInnerRadius); if (f) break
                    } l()
    ...
    }; la.prototype.registerSpace = function (a, d) { "top" === a ? this._topOccupied += d.height : "bottom" === a ? this._bottomOccupied += d.height : "left" === a ? this._leftOccupied += d.width : "right" === a && (this._rightOccupied += d.width) }; la.prototype.unRegisterSpace = function (a, d) {
    ...
    function (a) {
        a && this.ctx.save(); var d = this.ctx.font; this.ctx.textBaseline = this.textBaseline; var b = 0; this._isDirty && this.measureText(this.ctx); this.ctx.translate(this.x, this.y + b); "middle" === this.textBaseline && (b = -this._lineHeight / 2); this.ctx.font = this._getFontString(); this.ctx.rotate(Math.PI / 180 * this.angle); var c = 0, f = this.padding, g = null; (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(0, b, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor,
        this.borderColor); this.ctx.fillStyle = this.fontColor; for (b = 0; b < this._wrappedText.lines.length; b++) g = this._wrappedText.lines[b], "right" === this.horizontalAlign ? c = this.width - g.width - this.padding : "left" === this.horizontalAlign ? c = this.padding : "center" === this.horizontalAlign && (c = (this.width - 2 * this.padding) / 2 - g.width / 2 + this.padding), this.ctx.fillText(g.text, c, f), f += g.height; this.ctx.font = d; a && this.ctx.restore()
    }; X.prototype.setText = function (a) { this.text = a; this._isDirty = !0; this._wrappedText = null }; X.prototype.measureText =
    function () { this._lineHeight = Ka(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock"; this._wrapText(this.ctx); this._isDirty = !1; return { width: this.width, height: this.height } }; X.prototype._getLineWithWidth = function (a, d, b) {
        a = String(a); if (!a) return { text: "", width: 0 }; var c = b = 0, f = a.length - 1, g = Infinity; for (this.ctx.font = this._getFontString() ; c <= f;) {
            var g = Math.floor((c + f) / 2), h = a.substr(0, g + 1); b = this.ctx.measureText(h).width; if (b < d) c = g + 1; else if (b >
            d) f = g - 1; else break
        } b > d && 1 < h.length && (h = h.substr(0, h.length - 1), b = this.ctx.measureText(h).width); d = !0; if (h.length === a.length || " " === a[h.length]) d = !1; d && (a = h.split(" "), 1 < a.length && a.pop(), h = a.join(" "), b = this.ctx.measureText(h).width); return { text: h, width: b }
    }; X.prototype._wrapText = function () {
        var a = new String(ma(String(this.text))), d = [], b = this.ctx.font, c = 0, f = 0; for (this.ctx.font = this._getFontString() ; 0 < a.length;) {
            var g = this.maxHeight - 2 * this.padding, h = this._getLineWithWidth(a, this.maxWidth - 2 * this.padding,
            !1); h.height = this._lineHeight; d.push(h); var l = f, f = Math.max(f, h.width), c = c + h.height, a = ma(a.slice(h.text.length, a.length)); g && c > g && (h = d.pop(), c -= h.height, f = l)
        } this._wrappedText = { lines: d, width: f, height: c }; this.width = f + 2 * this.padding; this.height = c + 2 * this.padding; this.ctx.font = b
    }; X.prototype._getFontString = function () {
        var a; a = "" + (this.fontStyle ? this.fontStyle + " " : ""); a += this.fontWeight ? this.fontWeight + " " : ""; a += this.fontSize ? this.fontSize + "px " : ""; var d = this.fontFamily ? this.fontFamily + "" : ""; !v && d && (d = d.split(",")[0],
        "'" !== d[0] && '"' !== d[0] && (d = "'" + d + "'")); return a += d
    }; U(oa, M); oa.prototype.render = function () {
        if (this.text) {
            ...
            this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = d.height - 4), g = 0.5 * d.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = d.width - 4), g = 0.5 * d.height - 4)); this.wrap || (g = Math.min(g, Math.max(1.5 * this.fontSize, this.fontSize + 2.5 * this.padding))); var g = new X(this.ctx, {
                fontSize: this.fontSize, fontFamily: this.fontFamily, fontColor: this.fontColor, fontStyle: this.fontStyle, fontWeight: this.fontWeight, horizontalAlign: this.horizontalAlign,
                verticalAlign: this.verticalAlign, borderColor: this.borderColor, borderThickness: this.borderThickness, backgroundColor: this.backgroundColor, maxWidth: this.maxWidth, maxHeight: g, cornerRadius: this.cornerRadius, text: this.text, padding: this.padding, textBaseline: "top"
            }), n = g.measureText(); "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (c = d.y1 + 2, k = "top") : "bottom" === this.verticalAlign && (c = d.y2 - 2 - n.height, k = "bottom"), "left" === this.horizontalAlign ? b = d.x1 + 2 : "center" === this.horizontalAlign ?
    ...
    }; U(xa, M); xa.prototype.render = oa.prototype.render; U(ya, M); ya.prototype.render = function () {
        ...
        this.verticalAlign && (this.orientation = "vertical", b = this.horizontalAlign, g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width, h = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height); for (var m = 0; m < this.dataSeries.length; m++) {
            var p = this.dataSeries[m]; if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                ...
                Math.max(1, Math.round(0.2 * s)) : 0, r = this.chart.replaceKeywordsWithValue(r, p.dataPoints[0], p, m), e = { markerType: e, markerColor: q, text: r, textBlock: null, chartType: p.type, markerSize: s, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: u, markerBorderThickness: w }; k.push(e)
                ...
                w = t.legendMarkerBorderThickness ? t.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : t.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, r = this.chart.replaceKeywordsWithValue(r, t, p, v), e = { markerType: e, markerColor: q, text: r, textBlock: null, chartType: p.type, markerSize: s, dataSeriesIndex: m, dataPointIndex: v, markerBorderColor: u, markerBorderThickness: w }; (t.showInLegend || p.showInLegend && !1 !== t.showInLegend) && k.push(e)
            }
        } !0 === this.reversed && k.reverse();
        if (0 < k.length) {
            p = null; q = v = r = t = 0; r = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, g) : this.itemMaxWidth = Math.min(this.itemWidth, g) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, g) : this.itemMaxWidth = g; s = 0 === s ? 0.75 * this.lineHeight : s; r -= s + l; for (m = 0; m < k.length; m++) {
                e = k[m]; if ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType) r -= 2 * 0.1 * this.lineHeight; if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        s + l + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = { items: [], width: 0 }, n.push(p), this.height += v, v = 0; v = Math.max(v, e.textBlock.height)
                    } else e.textBlock = new X(this.ctx, { x: 0, y: 0, maxWidth: r, maxHeight: !0 === this.itemWrap ? h : 1.5 * this.fontSize, angle: 0, text: e.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }),
                    ...
                    0.1 * this.lineHeight : 0)); p.items.push(e); this.width = Math.max(p.width, this.width); q = e.textBlock.width + (s + l + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))
                }
            } this.itemWidth = q; this.height = !1 === this.itemWrap ? n.length * this.lineHeight : this.height + v; this.height = Math.min(h, this.height); this.width = Math.min(g, this.width)
        ...
        c = d.y1) : "center" === this.verticalAlign ? (f = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, c = d.y1 + d.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (f = "left" === this.horizontalAlign ? d.x1 : "right" === this.horizontalAlign ? d.x2 - this.width : d.x1 + d.width / 2 - this.width / 2, c = d.y2 - this.height); this.items = k; for (m = 0; m < this.items.length; m++) e = k[m], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = {
            ...
            p = n[m]; for (t = v = 0; t < p.items.length; t++) {
    ...
    }; U(Da, M); Da.prototype.render = function () { var a = this.chart.layoutManager.getFreeSpace(); this.ctx.fillStyle = "red"; this.ctx.fillRect(a.x1, a.y1, a.x2, a.y2) }; U(ba, M); ba.prototype.getDefaultAxisPlacement =
    function () {
        ...
        a || "funnel" === a) return "none"; window.console.log("Unknown Chart Type: " + a); return null
    }; ba.getDefaultLegendMarker = function (a) {
        if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a) return "square"; if ("line" === a || "stepLine" === a || "spline" === a || "pie" === a || "doughnut" ===
        a || "funnel" === a) return "circle"; if ("area" === a || "splineArea" === a || "stackedArea" === a || "stackedArea100" === a) return "triangle"; window.console.log("Unknown Chart Type: " + a); return null
    }; ba.prototype.getDataPointAtX = function (a, d) {
        if (!this.dataPoints || 0 === this.dataPoints.length) return null; var b = { dataPoint: null, distance: Infinity, index: NaN }, c = null, f = 0, g = 0, h = 1, l = Infinity, k = 0, n = 0, m = 0; "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (m = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
        m = 1 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (m = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, m = 0 < m ? Math.min(Math.max((this.dataPoints.length - 1) / m * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0)); for (; ;) {
            g = 0 < h ? m + f : m - f; if (0 <= g && g < this.dataPoints.length) {
                var c = this.dataPoints[g], p = this.axisX.logarithmic ? c.x > a ? c.x / a : a / c.x : Math.abs(c.x - a); p < b.distance && (b.dataPoint = c, b.distance = p, b.index = g); c = p; c <= l ?
                l = c : 0 < h ? k++ : n++; if (1E3 < k && 1E3 < n) break
        ...
        if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || d < this.chart.plotArea.y1 || d > this.chart.plotArea.y2) return null; b = b || !1; var c = [], f = 0, g = 0, h = 1, l = !1, k = Infinity, n = 0, m = 0, p = 0; "none" !== this.chart.plotInfo.axisPlacement && (p = (this.chart.axisX[0] ?
        this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic ? (g = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (g = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * (p - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0)); for (; ;) {
            g = 0 < h ? p + f : p - f; if (0 <= g && g < this.dataPoints.length) {
                var e =
                this.chart._eventManager.objectMap[this.dataPointIds[g]], r = this.dataPoints[g], q = null; if (e) {
                    switch (this.type) {
                        ...
                        360) % 360).toFixed(12)), u = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < e.endAngle && (u = 360), s >= u && 0 !== r.y && (u += 360, q < s && (q += 360)), q > s && q < u && (c.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: 0 }), l = !0)); break; case "candlestick": if (a >= e.x1 - e.borderThickness / 2 && a <= e.x2 + e.borderThickness / 2 && d >= e.y2 - e.borderThickness / 2 && d <= e.y3 + e.borderThickness / 2 || Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && d >= e.y1 && d <= e.y4) c.push({
    ...
    }; U(A, M); A.prototype.createExtraLabelsForLog = function (a) {
        a = (a || 0) + 1; if (!(5 < a)) {
            var d = this.logLabelValues[0] || this.intervalStartPosition; if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                ...
                3), !0), c = Math.ceil(this.viewportMinimum / b) * b; c < d; c += b) c < this.viewportMinimum || this.logLabelValues.push(c); this.logLabelValues.sort(Aa); this.createExtraLabelsForLog(a)
            }
        }
        ...
        this.intervalType, this.interval), f = Ia(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ia(b, l, this.intervalType)) a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : Fa(b, this.valueFormatString, this.chart._cultureInfo), a = new X(this.ctx, {
            x: 0, y: 0, maxWidth: g, backgroundColor: this.labelBackgroundColor, maxHeight: h, angle: this.labelAngle,
            text: this.prefix + a + this.suffix, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle"
        }), this._labels.push({ position: b.getTime(), textBlock: a, effectiveHeight: null }); else {
            f = this.viewportMaximum; if (this.labels) {
                a = Math.ceil(l); for (var l = Math.ceil(this.intervalStartPosition), p = !1, b = l; b < this.viewportMaximum; b += a) if (this.labels[b]) p = !0; else { p = !1; break } p && (this.interval =
            ...
            b * Math.pow(this.logarithmBase, this.interval) : b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : fa(b, this.valueFormatString, this.chart._cultureInfo), a = new X(this.ctx, {
                x: 0, y: 0, maxWidth: g, maxHeight: h, angle: this.labelAngle, text: this.prefix + a + this.suffix, horizontalAlign: "left", backgroundColor: this.labelBackgroundColor, fontSize: this.labelFontSize,
                fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle", borderThickness: 0
        ...
        this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (g = 0.9 * k >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = g; this.sessionVariables.labelMaxHeight = h; this.sessionVariables.labelAngle = this.labelAngle; this.sessionVariables.labelWrap = this.labelWrap; for (b = 0; b < this._labels.length; b++) {
                a = this._labels[b].textBlock; for (var q,
        ...
        this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = x(this.options.labelWrap) ? this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = this.sessionVariables.labelMaxHeight, a.measureText(); for (b = 0; b < this.stripLines.length; b++) {
            var g = this.stripLines[b], u; if ("outside" === g.labelPlacement) {
                h = this.sessionVariables.labelMaxWidth; if ("bottom" === this._position || "top" === this._position) u = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 *
                this.chart.height >> 0 : 1.5 * this.labelFontSize; if ("left" === this._position || "right" === this._position) u = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize; d = x(g.options.labelBackgroundColor) ? "#EEEEEE" : g.options.labelBackgroundColor
            ...
            "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, d = x(g.options.labelBackgroundColor) ? x(g.startValue) && 0 !== g.startValue ? v ? "transparent" : null : "#EEEEEE" : g.options.labelBackgroundColor; a = new X(this.ctx, {
                x: 0, y: 0, backgroundColor: d, maxWidth: g.options.labelMaxWidth ? g.options.labelMaxWidth : h, maxHeight: u, angle: this.labelAngle, text: g.labelFormatter ? g.labelFormatter({ chart: this.chart, axis: this, stripLine: g }) : g.label, horizontalAlign: "left", fontSize: "outside" === g.labelPlacement ?
        ...
        var a = 0, d = 0; this._labels = []; this._stripLineLabels = []; if ("left" === this._position || "right" === this._position) {
            this.createLabels(); for (d = 0; d < this._labels.length; d++) {
                ...
                a < f && (a = f); this._labels[d].effectiveWidth = f
        ...
        var a = 0; this._labels = []; this._stripLineLabels = []; var d, b = 0; this.createLabels(); if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) {
                d = this._labels[b].textBlock; var c = d.measureText(), f = 0, f = 0 === this.labelAngle ? c.height : c.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (c.height -
                d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)); a < f && (a = f); this._labels[b].effectiveHeight = f
        ...
        var h, l, k, n, m = a[0] ? a[0].chart : d[0].chart, p = m.ctx; if (a && 0 < a.length) for (var e = 0; e < a.length; e++) a[e] && a[e].calculateAxisParameters(); if (d && 0 < d.length) for (e = 0; e < d.length; e++) d[e].calculateAxisParameters(); if (b && 0 < b.length) for (e = 0; e < b.length; e++) b[e].calculateAxisParameters(); if (c && 0 < c.length) for (e = 0; e < c.length; e++) c[e].calculateAxisParameters(); var r = 0, q = 0, s = 0, u = 0, w = 0, v = 0, t = 0, z, A, D = l = 0, E, F, K,
        ...
        new X(c[e].ctx, { text: c[e].title, horizontalAlign: "center", fontSize: c[e].titleFontSize, fontFamily: c[e].titleFontFamily, fontWeight: c[e].titleFontWeight, fontColor: c[e].titleFontColor, fontStyle: c[e].titleFontStyle, textBaseline: "top" })); if ("normal" === f) {
            var u = [], w = [], v = [], t = [], G = [], H = [], J = [], M = []; if (a && 0 < a.length) for (e = 0; e < a.length; e++) a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ? 0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle =
            ...
            c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.height, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.width : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle = 90); for (; 4 > r;) {
                var L = 0, R = 0, P = 0, O = 0, N = f = 0, B = 0, S = 0, Y = 0, W = 0, V = 0, U = 0; if (b && 0 < b.length) for (v = [], e = V = 0; e < b.length; e++) v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), V += v[e], B += b[e] ? b[e].margin : 0; else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0)); J.push(v); if (c && 0 < c.length) for (t = [], e = U = 0; e < c.length; e++) t.push(Math.ceil(c[e] ?
                ...
                if (c && 0 < c.length) for (e = 0; e < c.length; e++) c[e].calculateValueToPixelConversionParameters(); if (0 < r) { if (a && 0 < a.length) for (e = 0; e < a.length; e++) E = G[r - 1][e] === G[r][e] ? !0 : !1; else E = !0; if (d && 0 < d.length) for (e = 0; e < d.length; e++) F = H[r - 1][e] === H[r][e] ? !0 : !1; else F = !0; if (b && 0 < b.length) for (e = 0; e < b.length; e++) K = J[r - 1][e] === J[r][e] ? !0 : !1; else K = !0; if (c && 0 < c.length) for (e = 0; e < c.length; e++) I = M[r - 1][e] === M[r][e] ? !0 : !1; else I = !0 } if (E && F && K && I) break; r++
            } p.save(); p.beginPath(); a[0] && p.rect(5, a[0].bounds.y1, a[0].chart.width -
            ...
            z = []; A = []; D = []; q = []; s = []; G = []; H = []; J = []; if (a && 0 < a.length) for (e = 0; e < a.length; e++) a[e] &&
            ...
            b[e].titleMaxWidth || g.width, b[e]._titleTextBlock.maxHeight = b[e].titleWrap ? 0.8 * g.height : 1.5 * b[e].titleFontSize, b[e]._titleTextBlock.angle = 0); if (c && 0 < c.length) for (e = 0; e < c.length; e++) c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.width, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.height : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle = 0); for (; 4 > r;) {
                ...
                c[e].lineCoordinates.y1 = n, c[e].lineCoordinates.y2 = n, c[e].bounds = { x1: h, y1: l + (c[e].margin + R), x2: k, y2: n, width: k - h, height: V }, c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width), R += A[e] + c[e].margin); if (a && 0 < a.length) for (e = 0; e < a.length; e++) {
                    B = a[e]._labels && 0 < a[e]._labels.length ? a[e]._labels[0].textBlock.fontSize / 2 : 0; h = Math.round(g.x1 + f); l = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y2 : g.y1 < Math.max(B,
                ...
                K && I) break; r++
            } if (b && 0 < b.length) for (e = 0; e < b.length; e++) b[e].renderLabelsTicksAndTitle(); if (c && 0 < c.length) for (e = 0; e < c.length; e++) c[e].renderLabelsTicksAndTitle(); if (a && 0 < a.length) for (e = 0; e < a.length; e++) a[e].renderLabelsTicksAndTitle(); if (d && 0 < d.length) for (e = 0; e < d.length; e++) d[e].renderLabelsTicksAndTitle()
        } m.preparePlotArea(); g = m.plotArea; p.save(); p.beginPath(); p.rect(g.x1, g.y1, Math.abs(g.x2 - g.x1), Math.abs(g.y2 - g.y1)); p.clip(); if (a && 0 < a.length) for (e = 0; e < a.length; e++) a[e].renderStripLinesOfThicknessType("value");
        ...
        0; e < a.length; e++) a[e].renderStripLinesOfThicknessType("pixel"); if (d && 0 < d.length) for (e = 0; e < d.length; e++) d[e].renderStripLinesOfThicknessType("pixel"); if (b && 0 < b.length) for (e = 0; e < b.length; e++) b[e].renderStripLinesOfThicknessType("pixel"); if (c && 0 < c.length) for (e = 0; e < c.length; e++) c[e].renderStripLinesOfThicknessType("pixel")
        ...
        var a = !1, d = 0, b = 0, c = 1, f = 0; 0 !== this.labelAngle && 360 !== this.labelAngle && (c = 1.2); if ("undefined" === typeof this.options.interval) {
            ...
            this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var d = [], c = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, h = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                    m = this._labels[k]; if (m.position < this.viewportMinimum) break; m.position > this.viewportMaximum || !(k === this._labels.length - 1 || g < Math.log(h / m.position) * l / c) || (d.push(m), h = m.position, g = m.textBlock.width * Math.abs(Math.cos(Math.PI /
                    180 * this.labelAngle)) + m.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                } this._labels = d
            } else { for (k = 0; k < this._labels.length; k++) m = this._labels[k], m.position < this.viewportMinimum || (m = m.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), d += m); d > this.lineCoordinates.width * c && this.labelAutoFit && (a = !0) } if ("left" === this._position || "right" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var d =
                ...
                this.viewportMinimum || (m = m.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + m.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += m); b > this.lineCoordinates.height * c && this.labelAutoFit && (a = !0)
            }
        ...
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            h = !1, c = 0; c < this.stripLines.length; c++) { var n = this.stripLines[c]; n._thicknessType === a && ("pixel" === a && (n.value < this.viewportMinimum || n.value > this.viewportMaximum || isNaN(this.range)) || l.push(n)) } for (c = 0; c < this._stripLineLabels.length; c++) if (n = this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                a = this.getPixelCoordinatesOnAxis(b.position); if ("outside" === b.stripLine.labelPlacement) if (n && (this.ctx.strokeStyle = n.color, "pixel" ===
                n._thicknessType && (this.ctx.lineWidth = n.thickness)), "bottom" === this._position) {
                    var m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0; this.ctx.beginPath(); this.ctx.moveTo(m, a.y << 0); this.ctx.lineTo(m, a.y + this.tickLength << 0); this.ctx.stroke(); 0 === this.labelAngle ? (a.x -= b.textBlock.width / 2, a.y += this.tickLength + b.textBlock.fontSize / 2) : (a.x -= 0 > this.labelAngle ? b.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, a.y += this.tickLength + Math.abs(0 > this.labelAngle ? b.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) -
                    5 : 5))
                ...
                h = !1; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (c = 0; c < l.length; c++) n = l[c], n.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                    ...
                    for (f = 0; f < l.length; f++) n = l[f], n.showOnTop && n.render(); this.ctx.restore()
                }, n)) : n.render(); for (c = 0; c < k.length; c++) b = k[c], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () { for (f = 0; f < k.length; f++) b = k[f], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), b.textBlock.render(!0), d.ctx.restore()) }, b.textBlock)) :
                "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0); this.ctx.restore(); h = !0
            } if (h) for (h = !1, c = 0; c < k.length; c++) b = k[c], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () { for (f = 0; f < k.length; f++) b = k[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0) }, b.textBlock)) : "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0)
        }
        ...
        var a = this.chart.ctx; a.save(); if ("bottom" === this._position || "top" === this._position) {
            if (this.lineThickness) {
                a.lineWidth =
                this.lineThickness; a.strokeStyle = this.lineColor ? this.lineColor : "black"; a.setLineDash && a.setLineDash(F(this.lineDashType, this.lineThickness)); var d = 1 === this.lineThickness % 2 ? (this.lineCoordinates.y1 << 0) + 0.5 : this.lineCoordinates.y1 << 0; a.beginPath(); a.moveTo(this.lineCoordinates.x1, d); a.lineTo(this.lineCoordinates.x2, d); a.stroke()
            }
        ...
        var d = {}; if ("bottom" === this._position || "top" === this._position) d.x = this.convertValueToPixel(a), d.y = this.lineCoordinates.y1; if ("left" === this._position || "right" === this._position) d.y = this.convertValueToPixel(a), d.x = this.lineCoordinates.x2;
        return d
    }; A.prototype.convertPixelToValue = function (a) { if ("undefined" === typeof a) return null; var d = 0, d = 0, d = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x; return d = this.logarithmic ? Math.pow(this.logarithmBase, (d - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit) * this.viewportMinimum : this.conversionParameters.minimum + (d - this.conversionParameters.reference) / this.conversionParameters.pixelPerUnit }; A.prototype.convertValueToPixel = function (a) {
    ...
    }; A.prototype.setViewPortRange = function (a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d); this.sessionVariables.newViewportMaximum = this.viewportMaximum = Math.max(a, d) }; A.prototype.getXValueAt =
    function (a) { if (!a) return null; var d = null; "left" === this._position ? d = this.convertPixelToValue(a.y) : "bottom" === this._position && (d = this.convertPixelToValue(a.x)); return d }; A.prototype.calculateValueToPixelConversionParameters = function (a) {
        a = { pixelPerUnit: null, minimum: null, reference: null }; var d = this.lineCoordinates.width, b = this.lineCoordinates.height; a.minimum = this.viewportMinimum; if ("bottom" === this._position || "top" === this._position) this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit =
        ...
        if (this.logarithmic) this.calculateLogarithamicAxisParameters(); else {
            ...
            40, c = 4; "axisX" === this.type && (c = 600 > this.maxWidth ? 8 : 6); var a = Math.max(c, Math.floor(this.maxWidth / a)), f, g, h, c = 0; if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum; if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = this.maximum; if ("axisX" === this.type) {
                if (this.dataSeries && 0 < this.dataSeries.length) for (f = 0; f < this.dataSeries.length; f++) "dateTime" === this.dataSeries[f].xValueType && (b = !0); f = null !== this.viewportMinimum ? this.viewportMinimum :
                this.dataInfo.viewPortMin; g = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax; 0 === g - f && (c = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, g += c, f -= c); Infinity !== this.dataInfo.minDiff ? h = this.dataInfo.minDiff : 1 < g - f ? h = 0.5 * Math.abs(g - f) : (h = 1, b && (d = !0))
            ...
            0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > g && (g = 0)); c = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? g : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? f : this.viewportMinimum); if ("axisX" === this.type && b) {
                ...
                this.intervalType = "number"; c = A.getNiceNumber(c, !1); this.interval =
            ...
            1 > this.range)) { d = Math.floor(Math.abs(Math.log(this.range) / Math.LN10)) + 2; if (isNaN(d) || !isFinite(d)) d = 2; if (2 < d) for (b = 0; b < d - 2; b++) this.valueFormatString += "#" }
        }
    }; A.prototype.calculateLogarithamicAxisParameters = function () {
        var a = this.chart.layoutManager.getFreeSpace(), d = Math.log(this.logarithmBase), b; "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight = a.width); var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth /
        ...
        this.equidistantInterval = !0, this.intervalStartPosition = c; if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { d = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2; if (isNaN(d) || !isFinite(d)) d = 2; if (2 < d) for (b = 0; b < d - 2; b++) this.valueFormatString += "#" }
    }; A.getNiceExponent = function (a, d) { var b = Math.floor(Math.log(a) / Math.LN10), c = a / Math.pow(10, b), c = 0 > b ? 1 >= c ? 1 : 5 >= c ? 5 : 10 : Math.max(Math.floor(c), 1); return Number((c * Math.pow(10, b)).toFixed(20)) }; A.getNiceNumber = function (a,
    d) { var b = Math.floor(Math.log(a) / Math.LN10), c = a / Math.pow(10, b); return Number(((d ? 1.5 > c ? 1 : 3 > c ? 2 : 7 > c ? 5 : 10 : 1 >= c ? 1 : 2 >= c ? 2 : 5 >= c ? 5 : 10) * Math.pow(10, b)).toFixed(20)) }; A.prototype.getLabelStartPoint = function () {
        var a = H[this.intervalType + "Duration"] * this.interval, a = new Date(Math.floor(this.viewportMinimum / a) * a); if ("millisecond" !== this.intervalType) if ("second" === this.intervalType) 0 < a.getMilliseconds() && (a.setSeconds(a.getSeconds() + 1), a.setMilliseconds(0)); else if ("minute" === this.intervalType) {
            if (0 < a.getSeconds() ||
    ...
    }; U(pa, M); pa.prototype.createUserOptions = function (a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder) {
            var d = 0; this.parent.options._isPlaceholder && this.parent.createUserOptions(); this.options._isPlaceholder || (sa(this.parent.stripLines), d = this.parent.options.stripLines.indexOf(this.options)); this.options =
            "undefined" === typeof a ? {} : a; this.parent.options.stripLines[d] = this.options
        }
        ...
        this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value), d = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit * this.thickness); if (0 < d) {
            var b = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var c = this.ctx.globalAlpha; this.ctx.globalAlpha = b; D(this.id); var f, g, h, l; this.ctx.lineWidth = d; this.ctx.setLineDash &&
    ...
    }; U(V, M); V.prototype._initialize = function () {
        if (this.enabled) {
    ...
    function (a, d) { this._lastUpdated && 40 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this._updateToolTip(a, d)) }; V.prototype._updateToolTip = function (a, d, b) {
        b = "undefined" === typeof b ? !0 : b; this.container || this._initialize(); this.enabled || this.hide(); if (!this.chart.disableToolTip) {
            if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY = d; var c = null, f = null, g = [], h = 0; if (this.shared &&
            this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    f = []; if (this.chart.axisX) for (var l = 0; l < this.chart.axisX.length; l++) { for (var h = this.chart.axisX[l].convertPixelToValue({ y: d }), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++) (k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k)); k = null } if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) {
                        h =
                        this.chart.axisX2[l].convertPixelToValue({ y: d }); k = null; for (c = 0; c < this.chart.axisX2[l].dataSeries.length; c++) (k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[l].dataSeries[c], null !== k.dataPoint.y && f.push(k)); k = null
                    }
                } else {
                    f = []; if (this.chart.axisX) for (l = 0; l < this.chart.axisX.length; l++) for (h = this.chart.axisX[l].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++) (k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h,
                    b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k)); if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) for (h = this.chart.axisX2[l].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX2[l].dataSeries.length; c++) (k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[l].dataSeries[c], null !== k.dataPoint.y && f.push(k))
                } if (0 === f.length) return; f.sort(function (a, b) { return a.distance - b.distance }); b = f[0];
                for (c = 0; c < f.length; c++) f[c].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() && g.push(f[c]); f = null
            } else {
                if (k = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex = k.dataSeries.index; else if (v) if (k = Ma(a, d, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) {
                    ...
                    f = this.chart.data[this.currentSeriesIndex]; k = {}; if (0 <= this.currentDataPointIndex) c = f.dataPoints[this.currentDataPointIndex], k.dataSeries = f, k.dataPoint = c, k.index = this.currentDataPointIndex, k.distance = Math.abs(c.x - h); else {
                        if (!this.enabled || "line" !== f.type && "stepLine" !== f.type && "spline" !== f.type && "area" !== f.type && "stepArea" !== f.type && "splineArea" !== f.type && "stackedArea" !==
                        f.type && "stackedArea100" !== f.type && "rangeArea" !== f.type && "rangeSplineArea" !== f.type && "candlestick" !== f.type && "ohlc" !== f.type) return; h = f.axisX.convertPixelToValue({ x: a }); k = f.getDataPointAtX(h, b); k.dataSeries = f; this.currentDataPointIndex = k.index; c = k.dataPoint
                    } if (!x(k.dataPoint.y)) if (k.dataSeries.axisY) if (0 < k.dataPoint.y.length) {
                        for (c = b = 0; c < k.dataPoint.y.length; c++) k.dataPoint.y[c] < k.dataSeries.axisY.viewportMinimum ? b-- : k.dataPoint.y[c] > k.dataSeries.axisY.viewportMaximum && b++; b < k.dataPoint.y.length &&
                ...
                } catch (n) { } "pie" === g[0].dataSeries.type || "doughnut" === g[0].dataSeries.type || "funnel" === g[0].dataSeries.type || "bar" === g[0].dataSeries.type || "rangeBar" === g[0].dataSeries.type || "stackedBar" === g[0].dataSeries.type || "stackedBar100" === g[0].dataSeries.type ? a = a - 10 - this.container.clientWidth : (a = g[0].dataSeries.axisX.convertValueToPixel(g[0].dataPoint.x) - this.container.clientWidth << 0, a -= 10); 0 > a && (a += this.container.clientWidth + 20); a + this.container.clientWidth >
        ...
        d.clearRect(0, 0, this.chart.width, this.chart.height); d.save(); var b = this.chart.plotArea, c = 0; d.beginPath(); d.rect(b.x1, b.y1, b.x2 - b.x1, b.y2 - b.y1); d.clip(); for (b = 0; b < a.length; b++) {
            var f = a[b]; if ((f = this.chart._eventManager.objectMap[f.dataSeries.dataPointIds[f.index]]) && f.objectType && "dataPoint" === f.objectType) {
                var c = this.chart.data[f.dataSeriesIndex], g = c.dataPoints[f.dataPointIndex], h = f.dataPointIndex; !1 === g.highlightEnabled || !0 !== c.highlightEnabled && !0 !== g.highlightEnabled || ("line" === c.type || "stepLine" ===
        ...
        var d = a.entries, b = null, c = null, f = null, g = 0; a = ""; for (var h = !0, l = 0; l < d.length; l++) if (d[l].dataSeries.toolTipContent || d[l].dataPoint.toolTipContent) { h = !1; break } if (h && (this.content && "function" === typeof this.content || this.contentFormatter)) d = { chart: this.chart, toolTip: this.options, entries: d }, b = this.contentFormatter ? this.contentFormatter(d) : this.content(d); else if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
            ...
            null !== c.options.toolTipContent)) {
                ...
                null === b && (b = ""); !0 === this.reversed ? (b = this.chart.replaceKeywordsWithValue(a, f, c, g) + b, l < d.length - 1 && (b = "</br>" + b)) : (b += this.chart.replaceKeywordsWithValue(a, f, c, g), l < d.length - 1 && (b += "</br>"))
            } null !== b && (b = n + b)
        } else {
            c = d[0].dataSeries; f = d[0].dataPoint; g = d[0].index; if (null === f.toolTipContent || "undefined" === typeof f.toolTipContent && null === c.options.toolTipContent) return null; if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" ===
            ...
            f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>" + (f.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}"; null === b && (b = ""); b += this.chart.replaceKeywordsWithValue(a, f, c, g)
        } this.content = a; for (l = 0; l < this.chart.data.length; l++) this.chart.data[l].toolTipContent =
        this.content; return b
    }; V.prototype.enableAnimation = function () { this.container.style.WebkitTransition || (this.container.style.WebkitTransition = "left .2s ease-out, bottom .2s ease-out", this.container.style.MozTransition = "left .2s ease-out, bottom .2s ease-out", this.container.style.MsTransition = "left .2s ease-out, bottom .2s ease-out", this.container.style.transition = "left .2s ease-out, bottom .2s ease-out") }; V.prototype.disableAnimation = function () {
    ...
    }; V.prototype.hide = function (a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) }; V.prototype.show = function (a, d, b) { this._updateToolTip(a, d, "undefined" === typeof b ? !1 : b) }; z.prototype.getPercentAndTotal = function (a, d) {
        var b = null, c = null, f = null; if (0 <= a.type.indexOf("stacked")) c =
        0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], f = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c)); else if ("pie" === a.type || "doughnut" === a.type) { for (i = c = 0; i < a.dataPoints.length; i++) isNaN(a.dataPoints[i].y) || (c += a.dataPoints[i].y); f = isNaN(d.y) ? 0 : 100 * (d.y / c) } return { percent: f, total: c }
    }; z.prototype.replaceKeywordsWithValue = function (a, d, b, c, f) {
        var g = this; f = "undefined" === typeof f ? 0 : f; if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <=
        a.indexOf("#total"))) {
    ...
    }; na.prototype.getNewObjectTrackingId = function () { return ++this.lastObjectId }; na.prototype.mouseEventHandler = function (a) {
        if ("mousemove" === a.type || "click" === a.type) {
            var d = [], b = za(a), c = null; if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c]) if (c = this.objectMap[c], "dataPoint" === c.objectType) {
            ...
            } else "legendItem" === c.objectType && (f = this.chart.data[c.dataSeriesIndex], g = null !== c.dataPointIndex ? f.dataPoints[c.dataPointIndex] : null, c.eventParameter = { x: b.x, y: b.y, dataSeries: f.options, dataPoint: g, dataPointIndex: c.dataPointIndex, dataSeriesIndex: c.dataSeriesIndex, chart: this.chart }, c.eventContext = {
                ...
                click: "itemclick"
            }, d.push(c)); f = []; for (b = 0; b < this.mouseoveredObjectMaps.length; b++) { g = !0; for (c = 0; c < d.length; c++) if (d[c].id === this.mouseoveredObjectMaps[b].id) { g = !1; break } g ? this.fireEvent(this.mouseoveredObjectMaps[b], "mouseout", a) : f.push(this.mouseoveredObjectMaps[b]) } this.mouseoveredObjectMaps = f; for (b = 0; b < d.length; b++) {
                f = !1; for (c = 0; c < this.mouseoveredObjectMaps.length; c++) if (d[b].id === this.mouseoveredObjectMaps[c].id) { f = !0; break } f || (this.fireEvent(d[b], "mouseover", a), this.mouseoveredObjectMaps.push(d[b]));
        ...
        if (a && d) {
            var c = a.eventParameter, f = a.eventContext, g = a.eventContext.userContext; g && (f && g[f[d]]) && g[f[d]].call(g, c); "mouseout" !== d ? g.cursor && g.cursor !== b.target.style.cursor && (b.target.style.cursor = g.cursor) : (b.target.style.cursor = this.chart._defaultCursor, delete a.eventParameter, delete a.eventContext); "click" === d && ("dataPoint" === a.objectType && this.chart.pieDoughnutClickHandler) &&
            this.chart.pieDoughnutClickHandler.call(this.chart.data[a.dataSeriesIndex], c)
        }
    }; U(qa, M); Ea.prototype.animate = function (a, d, b, c, f) {
        var g = this; this.chart.isAnimating = !0; f = f || E.easing.linear; b && this.animations.push({ startTime: (new Date).getTime() + (a ? a : 0), duration: d, animationCallback: b, onComplete: c }); for (a = []; 0 < this.animations.length;) if (d = this.animations.shift(), b = (new Date).getTime(), c = 0, d.startTime <= b && (c = f(Math.min(b - d.startTime, d.duration), 0, 1, d.duration), c = Math.min(c, 1), isNaN(c) || !isFinite(c)) &&
        (c = 1), 1 > c && a.push(d), d.animationCallback(c), 1 <= c && d.onComplete) d.onComplete(); this.animations = a; 0 < this.animations.length ? this.animationRequestId = this.chart.requestAnimFrame.call(window, function () { g.animate.call(g) }) : this.chart.isAnimating = !1
    }; Ea.prototype.cancelAllAnimations = function () { this.animations = []; this.animationRequestId && this.chart.cancelRequestAnimFrame.call(window, this.animationRequestId); this.animationRequestId = null; this.chart.isAnimating = !1 }; var E = {
        yScaleAnimation: function (a, d) {
            if (0 !==
            a) { var b = d.dest, c = d.source.canvas, f = d.animationBase; b.drawImage(c, 0, 0, c.width, c.height, 0, f - f * a, b.canvas.width / P, a * b.canvas.height / P) }
        }, xScaleAnimation: function (a, d) { if (0 !== a) { var b = d.dest, c = d.source.canvas, f = d.animationBase; b.drawImage(c, 0, 0, c.width, c.height, f - f * a, 0, a * b.canvas.width / P, b.canvas.height / P) } }, xClipAnimation: function (a, d) { if (0 !== a) { var b = d.dest, c = d.source.canvas; b.save(); 0 < a && b.drawImage(c, 0, 0, c.width * a, c.height, 0, 0, c.width * a / P, c.height / P); b.restore() } }, fadeInAnimation: function (a, d) {
            if (0 !==
            a) { var b = d.dest, c = d.source.canvas; b.save(); b.globalAlpha = a; b.drawImage(c, 0, 0, c.width, c.height, 0, 0, b.canvas.width / P, b.canvas.height / P); b.restore() }
        ...
        drawMarker: function (a, d, b, c, f, g, h, l) {
            if (b) {
                var k = 1; b.fillStyle = g ? g : "#000000";
        ...
        Chart: z, addColorSet: function (a, d) { ja[a] = d }, addCultureInfo: function (a,
        d) { ra[a] = d }, formatNumber: function (a, d, b) { b = b || "en"; if (ra[b]) return fa(a, d || "#,##0.##", new qa(b)); throw "Unknown Culture Name"; }, formatDate: function (a, d, b) { b = b || "en"; if (ra[b]) return Fa(a, d || "DD MMM YYYY", new qa(b)); throw "Unknown Culture Name"; }
    }; Qa.Chart.version = "v1.9.6 GA"; window.CanvasJS = Qa
})();
/*
